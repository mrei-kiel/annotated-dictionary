...
(\emph{b. idioms}) \B{Si\-\cp{va} ko!} Rise to the challenge! Courage! You can do it! 
\B{So\-lei\cp{a}}! \I{[so.lE.i."{}a]} \emph{or} \I{[so.lEj."{}a]} Congratulations! Nice going! You met the challenge! You did it!
\B{Sa\cp{sya}!} I'll rise to the challenge! I can do it! 
\B{Ätxä\-le si, oer syi\-vaw trr\-ay ha'\-ngir fa Skxayp?---Sa\-sya!} Could you call me on Skype tomorrow afternoon?---Sure will!\slash Will do! \emph{all}~\LINK{http://naviteri.org/2016/06/mrrvola-lifyavi-amip-forty-new-expressions/}{b}
...
\B{Nga\-ri so\-la\-lew pol\-pxay\-a zì\-sìt?\slash Nga\-ri so\-la\-lew zì\-sìt a\-pol\-pxay?} How old are you?
\B{Oe\-ri so\-la\-lew (so\-lew) zì\-sìt a\-pxe\-vol.} I'm 24 years old.~\emph{both}~\LINK{http://naviteri.org/2010/09/getting-to-know-you-part-2/}{b} \\
...
\B{Swey\-lu set txo aw\-nga ki\-vä pe\-sa\-lew\-fya\slash pe\-sa\-lew\-fya\-ìlä?} What direction should we go in now?
\B{Aw\-nga ze\-ne vi\-var ìlä fì\-sa\-lew\-fya. Zen\-ke yak si\-vi.} We must continue in this direction. We must not go astray.
(\emph{a. idiom}) \B{Set pe\-sa\-lew\-fya?} What do we do now?~\emph{all}~\LINK{http://naviteri.org/2013/09/on-si-salewfya-shapes-and-directions/}{b}
(\ding{43}~\HL{salew}{\B{sa\-lew}}, \HL{fya'o}{\B{fya\-'o}})

% san
\hi
\HT{san}{\B{san}} \I{[san]} \emph{part. to indicate the beginning of a quote with verbs of speech} \HL{plltxe}{\B{pll\-txe}}, \HL{peng}{\B{peng}}, \HL{pllngay}{\B{pll\-ngay}}, \HL{pawm}{\B{pawm}}, \emph{and writing} \HL{pamrel}{\B{pam\-rel si}}; \emph{used together with} \ding{43}~\HL{sIk}{\B{sìk}} \emph{when the speaker continues to say s.t. after the cited quote.}
...
\B{Po ke tsun pi\-vll\-ngay san oe\-ru tì\-kxey.} He can't admit he's wrong.
\B{Oe pll\-ngay san mo\-lak\-to oe nì\-fe', ta\-fral sno\-laytx; wä\-tu lu oe\-to txur.} I acknowledge that I rode badly, so I lost; my opponent was stronger than I was.~\emph{both}~\LINK{http://naviteri.org/2011/07/txantsana-ultxa-mi-siatll-great-meeting-in-seattle/}{b}
...
\textsc{Derivations}: \on{1}.~\HL{tIsay}{\B{tìsay}}, loyalty. \\
\on{2}.~\HL{nIsay}{\B{nìsay}}, loyally.

% saylahe
\hi
\HT{saylahe}{\B{say\cp{la}he}} \I{[saj."la.hE]} \emph{adv.} et cetera (etc.). (\emph{from} \B{sì aylahe}, \emph{in writing shortened to} \B{sl.}) 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sAfleltsyIp}{\B{sä\-flel\-tsyìp}}, practical joke.
...
\textsc{Derivations}: \on{1}.~\HL{txinfpIl}{\B{txin\-fpìl}}, main point.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIsAfpIlyewn}{\B{tì\-sä\-fpìl\-yewn}}, communication.
...
\B{Sä\-ftxu\-lì\-'u Tsyeyk\-ä Na'\-vi\-ru slan\-ti\-re so\-li nì\-wotx.} Jake's speech inspired all the People.
\B{Fni\-vu! Sä\-ftxu\-lì\-'u\-ri ke tsun oe sti\-vawm.} Hush! I can't hear the speech.~\emph{both}~\LINK{http://naviteri.org/2012/06/spring-vocabulary-part-3/}{b}
...
% sämunge
\hi
\HT{sAmunge}{\B{sä\cp{mu}nge}} \I{[s\ae."mu.NE]} \emph{or coll.} \I{["{}smu.NE]} \emph{n.} transportation tool or device (\emph{general term for any object used to carry or transport something else}).
...
\on{1}.~\HL{tsmisnrr}{\B{tsmisnrr}}, bladder lantern, nectar lantern. \\
...
\B{Oeyk tsa\-tì\-snaytx\-ä lu apxa sä\-nui tì\-eyk\-tan\-ä.} That loss was caused by a great failure of leadership.
\B{Fì\-sä\-nu\-it ze\-ne nga tswi\-va', ma 'i\-tan.} You must forget about this failure, my son.~\emph{both}~\LINK{http://naviteri.org/2013/04/wheres-the-bathroom-and-other-useful-things/}{b}
...
\on{1}.~\HL{sAnumvi}{\B{sänumvi}}, lesson.
...
% säomum
\hi
\HT{sAomum}{\B{sä\cp{o}mum}} \I{[s\ae."{}o.mum]} \emph{or} \I{[.mUm]} \emph{countable n.} (piece of) information.   
...
\on{1}.~\HL{sAplltxevi}{\B{säplltxevi}}, comment.
...
\B{Fì\-sä\-spxin\-ìri nge\-yä ke lä\-ngu kea 'um\-tsa.} Unfortunately there is no medicine for this disease of yours.~\emph{both}~\LINK{http://naviteri.org/2014/11/twenty-before-the-holidays/}{b} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{txawnulsrung}{\B{txaw\-nul\-srung}}, machine.
...
(\ding{214}~\HL{kesAtarenga'}{\B{ke\-sä\-ta\-re\-nga'}})
...
\B{Kxe\-ner lu sä\-vll txep\-ä.} Smoke is a sign\slash an indication that there is fire.
\B{Mì sa\-ngek a sä\-vll\-it ngo\-lop eyk\-yul tar\-po\-ngu\-ä.}
The sign on the tree trunk was made by the leader of the hunting party. \emph{both}~\LINK{http://naviteri.org/2017/12/zisit-amip-lefpom-ma-eylan-happy-new-year-friends/}{b}
...
\B{Sìl\-pey oe, fì\-sä\-wä\-sul\-tsyìp 'o' lì\-ye\-vu ay\-nga\-ru!} I hope, this little contest will be fun for you!
\B{Win\-a Sä\-wä\-sul\-tsyìp A\-hì\-'i.} A Quick Little Contest.~\emph{both}~\LINK{http://naviteri.org/2012/10/wina-sawasultsyip-ahii-a-quick-little-contest/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{syImawnun'i}{\B{syì\-maw\-nun\-'i}}, cut tie. 
...
% si
\hi
\HT{si}{\B{si}} \I{[si]} \emph{unprod. auxiliary v. to turn a n. or adj. into a v.:} \B{tì\-kang\-kem si}, to work. \B{win si}, to hurry. \emph{Grammatically vin., the logical direct object takes the dative case:}  
...
\emph{Special forms in} ‹\B{äp}› \emph{and} ‹\B{eyk}› \emph{exist, e.g.:} \B{ioi sä\-pi}, adorn oneself. \B{win sä\-pi}, hurry oneself. \B{tì\-sraw sey\-ki}, hurt s.o.
...
\B{Ta 'ey\-lan kar\-yu\-sì ay\-nge\-yä}. From your friend and teacher. 
...
\on{2}.~\HL{tsIlpey}{\B{tsìl\-pey}}, hope, hoping. \\
...
(\ding{43}~\B{swey}, \ding{214}~\B{fe'}, \B{kawng}) \\
...
(\emph{b. metaphorically with} \HL{kllkxem}{\B{kll\-kxem}} \emph{and} \HL{yI}{\B{yì}} \emph{to refer to the level of anything scalable: water level, temperature, talent, anger, etc.}) 
\B{Lì'\-fya\-ri po (kll\-kxem) sìn pe\-yì?} [\emph{coll.}: \I{[sIm.pE."jI]}]\slash \B{Lì'\-fyari po pe\-yì?} How good is her Na'vi?
\B{Sìn yì sngä\-'i\-yu\-ä, slä tsye\-rìl (hay\-a yì\-ne) nì\-'ul\-'ul.} They're at a beginner's level, but they're getting better and better.
\B{Sìn yì a ke tsun kaw\-tu spi\-vaw, nì\-win fra\-to.} He runs at an incredible level, faster than anyone else.~\emph{all}~\LINK{http://naviteri.org/2013/01/lifyari-po-peyi-how-good-is-her-navi/}{b}
...
(\ding{214}~\B{ftär}) \\
\on{1}.~\HL{skiempa}{\B{skiem\-pa}}, right side. \\
\on{2}.~\HL{nIskien}{\B{nì\-skien}}, to the right.
...
\B{Oe\-ri skxir a mì syokx tì\-sraw se\-ngi.} The wound on my hand hurts.
\B{Ze\-ne nga yi\-vur pxìm fì\-skxir\-it.} You must clean the wound frequently.~\emph{both}~\LINK{http://naviteri.org/2011/05/some-miscellaneous-vocabulary/}{b}
...
\on{1}.~\HL{tIsla'tsu}{\B{tìsla'tsu}}, description.
...
\B{Nge\-yä tsmu\-ke lu ken\-'aw lor slä\-kop ka\-nu.} Your sister is not only beautiful but also intelligent.
\B{Ay\-nga\-ri sìl\-pey oe tsnì ken\-'aw fpom\-tokx slä\-kop fpom\-ron yi\-vo'.} I hope that not only your physical but also your mental health will be perfect.
(\emph{b. on its own}) \B{Fra\-krr lu nge\-yä sì\-pawm ngä\-zìk slä\-kop le\-tsran\-ten.} Your questions are always difficult but also important.~\emph{all}~\LINK{http://naviteri.org/2014/10/tson-si-fpomron-obligation-and-mental-health/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{slosnep}{\B{slo\-snep}}, width.
...
\B{Po smon oer.} I know him.
\B{Sra\-ke smon ngar oe\-yä mey\-lan alu En\-tu sì Ka\-mun?} Do you know my friends En\-tu and Ka\-mun?~\emph{both}~\LINK{http://naviteri.org/2010/09/getting-to-know-you-part-1/}{b} 
...
% snanumultxa
\hi
\HT{snanumltxa}{\B{snanumul\cp{txa}}} \I{[sna.nu.mul."t'a]} \emph{or} \I{[.mUl.]} \emph{n.} course (\emph{of lectures}). 
...
% snaytx
\hi
\HT{snaytx}{\B{snaytx}} \I{[snajt']} \emph{vin.} lose (\emph{a game}).   
...
\B{Ay\-oe sno\-laytx fì\-trr ta\-lun\-a oel rum\-it to\-lung\-zup.} We lost today because I dropped the ball. 
\B{Oe pll\-ngay san mo\-lak\-to oe nì\-fe', ta\-fral sno\-laytx; wä\-tu lu oe\-to txur.} I acknowledge that I rode badly, so I lost; my opponent was stronger than I was.~\emph{all}~\LINK{http://naviteri.org/2011/07/txantsana-ultxa-mi-siatll-great-meeting-in-seattle/}{b} \\
\on{1}.~\HL{snaytu}{\B{snaytu}}, loser.
...
\B{Fì\-tsngan\-ur a sno\-läm lä\-ngu fa\-hew a\-kxä\-näng.} This rotten meat has a putrid smell.
\B{Ze\-ne fko tsko swi\-zaw\-it si\-var nì\-trr\-trr fte\-ke fì\-tsu\-'o sni\-väm.} One must use a bow and arrow regularly to prevent this ability degrading over time.~\emph{both}~\LINK{http://naviteri.org/2015/11/vomuna-liu-amip-ten-new-words/}{b}

% snep
\hi
\HT{snep}{\B{snep}} \I{[snEp\textcorner]} \emph{adj.} narrow.
(\ding{214}~\HL{sloa}{\B{sloa}}) \\
\on{1}.~\HL{slosnep}{\B{slosnep}}, width.
...
\on{1}.~\HL{snewsye}{\B{snewsye}}, weird, spooky.

% snewsye
\hi
\HT{snewsye}{\B{\cp{snew}sye}} \I{["{}snEw.sjE]} \emph{adj.} weird, spooky.   
\B{Ay\-nga\-ri ftxo\-zä Hä\-lo\-win\-ä li\-vu 'o' sì snew\-sye txan\-txew\-vay.} May your Halloween be as fun and spooky as possible.
\B{Oe\-ri lu fì\-tseng snew\-sye nì\-hawng. Hi\-vum ko.} This place is too spooky for me. Let's get out of here.~\emph{both}~\LINK{http://naviteri.org/2012/10/snewsyea-ftxoza-halowina-a-spooky-halloween/}{b}
(\ding{43}~\HL{snew}{\B{snew}}, \HL{syeha}{\B{sye\-ha}})

% sno
\hi
\HT{sno}{\B{sno}} \I{[sno]} (\emph{gen.} \ding{43}~\HL{sneyA}{\B{\cp{sne}yä}}) \emph{pn. 3\textsuperscript{rd} person singular to mean} ``his\slash her\slash their own''; \emph{indifferent to number; most often used in its genitive form}.
(\emph{a. subjective})
...
(\emph{c. dative})
\B{Po yaw\-ne lu snor.} He loves himself.
\B{Me\-fo yaw\-ne lu (snor) fì\-tsap.} They (= those two) love each other.
\B{Fo smon (sno\-ru) fì\-tsap nì\-wotx.} They all know each other.~\emph{all}~\LINK{http://naviteri.org/2011/12/one-more-for-2011/}{b} \\
\textsc{Derivations}:
...
% snolup
\hi
\HT{snolup}{\B{\cp{sno}lup}} \I{["sno.lup\textcorner]} \emph{or} \I{[.lUp\textcorner]} \emph{n.} personal style or aesthetic, presence.
...
\B{Nga\-ri sno\-mot krr\-pe ve\-zey\-ko, ma 'itan?} When are you going to organize your room, son?
(i.) \B{(sno)\-mo a ha\-haw}, bedroom.~\emph{both}~\LINK{http://naviteri.org/2012/10/mipa-vospxi-mipa-ayliu-new-words-for-the-new-month/}{b}
...
% snumìna
\hi
\HT{snumIna}{\B{\cp{snu}mìna}} \I{["{}snu.mI.na]} \emph{adj.} dim (\emph{of a person}). 
...
\B{Aw\-nga sngi\-vä\-'i ko!} Let's begin!
\B{Tì\-kang\-kem sngo\-lä\-'i.} The work began.~\emph{both}~\LINK{http://naviteri.org/2010/06/first-post/}{b}
...
% sngä'ikrr
\hi
\HT{sngA'ikrr}{\B{\cp{sngä}'ikrr}} \I{["{}sN\ae.Pi.k\s{r}]} \emph{n.} beginning, start time. 
\B{Txe\-wì\-yä sem\-pul\-ìri sngä\-'i\-krr Saw\-tu\-tet ve\-re'\-kì.} In the beginning, Txewì's father hated the Skypeople.~\LINK{http://naviteri.org/2010/07/ting-mikyun-fte-tslivam-listening-comprehension-1-3/}{b}
...
\B{Poel tì\-kang\-kem\-it sngey\-ko\-lä\-'i.} She began the work.
\B{Fwa oel fì\-tì\-kang\-kem\-vit sngey\-ki\-vä\-'i krr\-no\-lekx nì\-txan.} Me starting this project took a long time.~\emph{both}~\LINK{http://naviteri.org/2010/06/first-post/}{b} 
...
\on{1}.~\HL{sngumtsim}{\B{sngumtsim}}, worrisome matter. \\
...
\B{Lu oer sngum\-tsim fwa po ke zo\-la\-'u.} I have a feeling of worry that he didn't come.
\B{Pe\-yä ay\-lì\-'u a\-ing\-ye\-nga' lo\-lu sngum\-tsim ay\-oe\-ru nì\-wotx.} His mysterious words worried us all.
\B{Syor, ma 'ey\-lan, syor. Ke lu kea sngum\-tsim.} Relax, friend, relax. There's nothing to worry about.~\emph{all}~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}{b}
...
\B{Oel so'\-ha fu\-ta trr\-ay nga\-hu kä.} I'm excited about going with you tomorrow.
\B{Tse\-nul so'\-ha tey\-lut nì\-hawng nì\-'it, ke\-fyak?} Don't you think Tsenu is a bit too into \emph{teylu}?
\B{Saw\-no'\-ha ioit ko\-la\-ne\-i\-om oel u\-van\-fa!} I got (won) the prized piece of jewelry in the game!
(\emph{b. conv., intj.}) \B{Le\-iam fwa Txe\-wì Ri\-ni\-sì mun\-txa slì\-yu.---So'\-ha!} It looks like Txewì and Rini are about to get married.---That's great!~\emph{all}~\LINK{http://naviteri.org/2012/06/spring-vocabulary-part-3/}{b} \\
\on{1}.~\HL{tIso'ha}{\B{tìso'ha}}, enthusiasm, having a good attitude. \\
\on{2}.~\HL{leso'ha}{\B{leso'ha}}, enthusiastic, keen. \\
\on{3}.~\HL{nIso'ha}{\B{nìso'ha}}, enthusiastically. \\
\on{4}.~\HL{so'hayu}{\B{so'hayu}}, enthusiast.
...
(\ding{214}~\B{wew}) \\
\textsc{Derivations}: \on{1}.~\HL{tIsom}{\B{tìsom}}, heat. 
...
\on{1}.~\HL{tIsop}{\B{tìsop}}, journey. \\
\on{2}.~\HL{sopyu}{\B{sopyu}}, traveller.
...
% sosul
\hi
\HT{sosul}{\B{so\cp{sul}}} \I{[so."{}sul]} \emph{or} \I{[."{}sUl]} \emph{adj.} pleasant smell (\emph{of nearby running water, rain, moist vegetation}).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIspaw}{\B{tì\-spaw}}, belief (abstract).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIspe'e}{\B{tì\-spe\-'e}}, capture. 
...
\on{1}.~\HL{spulmokri}{\B{spulmokri}}, telephone. 
\on{2}.~\HL{spulyaney}{\B{spulyaney}}, canoe paddle.
...
% spxam
\hi
\HT{spxam}{\B{spxam}} \I{[sp'am]} \emph{n.} fungus. 
\textsc{Derivations}: \ding{43} \on{1}.~\HL{torukspxam}{\B{to\-ruk\-spxam}}, octoshroom.
\on{2}.~\HL{txepvispxam}{\B{txep\-vispxam}}, sparkle pod. 
...
\on{1}.~\HL{tIspxin}{\B{tìspxin}}, sickness, state of being sick. \\
\on{2}.~\HL{sAspxin}{\B{säspxin}}, sickness, disease, illness.
...
% sran / srane
\hi
\HT{sran}{\B{sran}} \I{[sRan]} \emph{or} \B{\cp{sra}ne} \I{["{}sRa.nE]} \emph{adv., intj.} yes, (\emph{coll.}) yeah.
...
\on{3}.~\HL{srankehe}{\B{srankehe}}, more or less.
...
(\emph{a. expression}) \B{Sra\-ke srätx (ngat) txo \ldots?} (\emph{with} ‹iv›) `Would you mind if \ldots?'
\B{Ke srätx (oet) txo \ldots} `I don't mind if \ldots'            
\B{Ke srätx kaw\-'it!\slash Kea sä\-srätx kaw\-'it!\slash Ke\-he kaw\-'it!} `Not at all!'~\emph{all} \LINK{http://naviteri.org/2020/11/vospxivopeya-ayliu-amip-novembers-new-words/}{b} \\
\on{1}.~\HL{sAsrAtx}{\B{säsrätx}}, annoyance.
...
\B{Set sre\-fey oel fu\-ta tsam\-po\-ngu tä\-txaw maw txon\-'ong.\slash Set sre\-fey oe tsnì tsam\-po\-ngu …} I'm currently expecting the war party back after nightfall.
(\emph{a. idiom}) \B{sre\-fe\-re\-i\-ey nì\-prr\-te'}, looking forward (to s.t.). \B{Tsa\-ria nga\-hu ye'\-rìn ul\-txa si nì\-mun, oe sre\-fe\-re\-i\-ey nì\-prr\-te'.} I'm looking forward to getting together with you again soon.~\emph{all}~\LINK{http://naviteri.org/2011/02/new-vocabulary-part-2/}{b}
...
\B{Sre\-fpìl oel fu\-ta nga lu tok\-tor Lì\-vìng\-sì\-ton.} Doctor Livingstone, I presume.
\B{Sre\-fpìl Oma\-ti\-ka\-ya tsnì Tsyeyk kaw\-krr ke ta\-yä\-txaw maw ka\-vuk sne\-yä.} The Omaticaya assumed that Jake would never return after his treachery.~\emph{both}~\LINK{http://naviteri.org/2014/10/tson-si-fpomron-obligation-and-mental-health/}{b}
...
\on{1}.~\HL{sAsrese'a}{\B{säsrese'a}}, prediction.
...
% srung / srung si
\hi
\HT{srung}{\B{srung}} \I{[sRuN]} \emph{or} \I{[sRUN]} \textsc{i}. \emph{n.} help, assistance. \\
\textsc{ii}. \HT{srungsi}{\B{srung si}} \I{[sRuN si]} \emph{vin.} (\emph{a.}) help (s.o.). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{srungsiyu}{\B{srung\-si\-yu}}, assistant, helper. 
...
% srunga' 
\hi
\HT{srunga'}{\B{\cp{sru}nga'}} \I{["{}sRu.NaP]} \emph{adj.} helpful (\emph{not for people}).
\B{Tì\-yäkx ke lu sru\-nga', ma tsmuk. Nga txo sti, oeyk\-tìng teyng\-ta pe\-lun.} Snubbing isn't helpful, brother. If you're angry, explain why.
(\emph{a. proverb}) \B{Hem a\-sru\-nga' nì\-'ul, hum a\-sngu\-nga' nì\-nän.}
More helpful actions lead to less troubling outcomes.~\emph{both}~\LINK{http://naviteri.org/2015/03/kap-si-ayunil-saylahe-threats-dreams-and-other-things/}{b} 
(\ding{43}~\HL{srung}{\B{srung}}, \HL{srungsi}{\B{srung si}} (\emph{b.}))

% srungsiyu
\hi
\HT{srungsiyu}{\B{\cp{srung}siyu}} \I{["{}sRuN.si.ju]} \emph{n.} assistant, helper, one who helps.
...
(\ding{43}~\HL{srungsi}{\B{srung si}})

% srungtsyìp
\hi
\HT{srungtsyIp}{\B{\cp{srung}tsyìp}} \I{["{}sRuN.\t{ts}jIp\textcorner]} \emph{n.} helpful hint, tip.
...
\on{1}.~\HL{stA'nIpam}{\B{stä'nìpam}}, recording.
...
\textsc{ii}. \B{\cp{stä'}nìpam si} \I{[st\ae{}P.nI.pam si]} \emph{vin.} record, make a recording. 
\B{Sä\-ftxu\-lì\-'u a\-tì\-txur\-nga' nì\-txan nang! Fu\-ria tsa\-ru nga stä'\-nì\-pam so\-li, ira\-yo.} What a powerful speech! Thank you for recording it.~\emph{both}~\LINK{http://naviteri.org/2019/10/vurway-alor-a-beautiful-narrative-poem-2/}{b}
...
\on{1}.~\HL{tIsteftxaw}{\B{tìsteftxaw}}, examination.

% steng
\hi
\HT{steng}{\B{steng}} \I{[stEN]} \emph{adj.} similar.   
\B{Me\-unil\-tì\-ran\-tokx Tok\-tor Kì\-rey\-sä sì Tsyeyk\-ä ke lu teng ki steng.} The avatars of Grace and Jake aren't the same, but they are similar.
\B{Nga\-ru tì\-yawr. Lo\-lu oer steng\-a sä\-fpìl.} You're right. I had a similar idea.
(\emph{a. proverb}) \B{Sä\-fpìl a\-steng, tì\-kan a\-teng.} Great minds think alike [lit.: similar thought, same aim].~\emph{all}~\LINK{http://naviteri.org/2011/09/miscellaneous-vocabulary/}{b} \\
\on{1}.~\HL{nIsteng}{\B{nìsteng}}, similarly.
...
\B{Oe\-ru txoa li\-vu, ma 'ey\-lan. Rä\-'ä sti\-vi. Lu hì\-'i\-a sä\-'i\-pu nì\-'aw.} I'm sorry, friend. Don't be angry. It was just a small bit of humor.~\LINK{http://naviteri.org/2012/01/mipa-zisit-ayliu-amip-new-words-for-the-new-year/}{b}
\B{Fu\-ri\-a fì\-lì'\-fya\-vit fkol ta 'Ìng\-lì\-sì mo\-lu\-nge, sìl\-pey oe tsnì ay\-ha\-pxì\-tu lì'\-fya\-o\-lo'\-ä aw\-nge\-yä ke stì\-ye\-vi.} That this expression is brought from English, will hopefully not anger the members of the language group.~\LINK{http://forum.learnnavi.org/language-updates/txelanit-hivawl/}{ln} \\
\on{1}.~\HL{steyki}{\B{steyki}}, make (s.o.) angry. \\
\on{2}.~\HL{tIsti}{\B{tìsti}}, anger. \\
\on{3}.~\HL{nIsti}{\B{nìsti}}, angrily.
...
\on{1}.~\HL{stiwinga'}{\B{stiwinga'}}, mischievous. \\
\on{2}.~\HL{stiwiyu}{\B{stiwiyu}}, mischief\hyp{}maker.
...
\B{Sto\-lo po hi\-vum fo\-hu.} She refused to leave with them.
\B{Po\-el sto\-la\-tso fu\-ta me\-fo ti\-va\-ron tsa\-ha'\-ngir.} She must have refused their request to hunt that afternoon.~\emph{all}~\LINK{http://forum.learnnavi.org/language-updates/sto-has-the-same-syntax-as-new/}{ln}

% stum
\hi
\HT{stum}{\B{stum}} \I{[stum]} \emph{or} \I{[stUm]} \emph{adv.} (\emph{a.}) almost. 
...
% stxeli
\hi
\HT{stxeli}{\B{\cp{stxe}li}} \I{["{}stE.li]} \emph{n.} gift, present.   
...
\B{Ngal lum\-pe oe\-yä stxe\-nut tsyo\-lä\-ngär?} Why did you reject my offer?
\B{Po pol\-txe san tì\-tstew\-nga'\-a stxe\-nu\-ri ira\-yo sei\-yi oe nga\-ru nì\-txan.} She said, ``I thank you very much for your courageous offer.''
~\emph{both}~\LINK{http://naviteri.org/2011/09/miscellaneous-vocabulary/}{b}
(\ding{43}~\HL{stxeli}{\B{stxe\-li}}, \HL{lonu}{\B{lo\-nu}}) \\
\on{1}.~\HL{stxenutIng}{\B{stxenutìng}}, offer (s.t.).

% stxenutìng
\hi
\HT{stxenutIng}{\B{\cp{stxe}nutìng}} \I{["{}stE.nu.t$\cdot$IN]} \emph{vtr., inf.}\on{33} offer (s.t.).
\B{Oe\-ri tì\-rey\-ti oel stxe\-nu\-to\-lìng fpi olo' aw\-nge\-yä.} I offered my life for the sake of our clan.
\B{Stxe\-nu\-to\-lìng oel fu\-ta lì'\-fyat le\-Na'\-vi poe\-ru ki\-var. Mol\-'an nì\-prr\-te'.} I offered to teach her Na’vi. She accepted gladly.
\emph{both}~\LINK{http://naviteri.org/2011/09/miscellaneous-vocabulary/}{b}
...
% sung 
\hi
\HT{sung}{\B{sung}} \I{[suN]} \emph{or} \I{[sUN]} \emph{vtr.} add. 
...
\on{1}.~\HL{nIsung}{\B{nìsung}}, besides, additionally, furthermore. \\
\on{2}.~\HL{tIsung}{\B{tìsung}}, addition, post script. \\
\on{3}.~\HL{'opinsung}{\B{'opinsung}}, color, color in.

% sur
\hi
\HT{sur}{\B{sur}} \I{[suR]} \emph{or} \I{[sUR]} \emph{n.} (\emph{a. sensation}) taste, flavor. 
(\emph{b. to form the middle voice}) \B{Fì\-na\-er\-ìri sur fkan oe\-ru ka\-lin.} This drink tastes sweet to me.
\B{Fì\-na\-er\-ìri sur fkan lor.} This drink tastes good.~\emph{both}~\LINK{http://naviteri.org/2012/11/renu-ayinanfyaya-the-senses-paradigm/}{b}

% susyang
\hi
\HT{susyang}{\B{su\cp{syang}}} \I{[su."sjaN]} \emph{adj.} fragile, delicate. 
\B{Lu fì\-vul su\-syang nì\-txan. Txo fko ti\-vìng zek\-wä kxakx.} This branch is very fragile. If you touch it, it'll break.
\B{Rey\-'eng lu su\-syang.} The balance of life is fragile.~\emph{both}~\LINK{http://naviteri.org/2015/04/some-new-words-for-may-day/}{b}

% sutx
\hi
\HT{sutx}{\B{sutx}} \I{[sut']} \emph{or} \I{[sUt']} \emph{vtr.} track, follow, lock up. 
\B{Po spä few pay\-fya fte smar\-it si\-vutx.} He jumped across the stream to track his prey.~\LINK{http://naviteri.org/2011/01/new-year-new-vocabulary/}{b}
\B{Tì\-tu\-sa\-ron\-ìri fte fli\-vä, ze\-ne fko si\-vutx smar\-it ni\-nan nì\-no.} To succeed at hunting, you have to track your prey by reading (the forest) with attention to detail.~\LINK{http://naviteri.org/2011/09/\%E2\%80\%9Cby-the-way-what-are-you-reading\%E2\%80\%9D/}{b} \\
...
\on{1}.~\HL{pxisawam}{\B{pxiswawam}}, just a moment ago. \\
\on{2}.~\HL{pxiswaway}{\B{pxiswaway}}, in just second (from now). \\
\on{3}.~\HL{swawtsyIp}{\B{swawtsyìp}}, little moment. 

% swawtsyìp 
\hi
\HT{swawtsyIp}{\B{\cp{swaw}tsyìp}} \I{["{}swaw.\t{ts}jIp\textcorner]} \emph{n.} little moment, second.
\B{'Aw\-a swaw\-tsyìp. Oe fpe\-rìl.} Just a moment. I'm thinking. 
\B{'Aw\-a swaw\-tsyìp li\-vu oer.} May I have a tiny moment.~\emph{both}~\LINK{http://naviteri.org/2010/09/getting-to-know-you-part-3/}{b}
...
\B{Swey\-lu txo nga ki\-vä.\slash Nga swey\-lu txo ki\-vä.} You should go.
\B{Swey\-lu txo nga ke ki\-vä.\slash Nga swey\-lu txo ke ki\-vä.} You shouldn't go.
\B{Swey\-lu txo ki\-vä.} I\slash you\slash she\slash one\slash etc. should go.
...
\B{Swey\-lu fwa nga ko\-lä.} You should have gone.~\emph{all}~\LINK{http://naviteri.org/2011/04/\%E2\%80\%99a\%E2\%80\%99awa-li\%E2\%80\%99fyavi-amip\%E2\%80\%94a-few-new-expressions/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{swizawsena}{\B{swi\-zaw\-se\-na}}, quiver. 
...
\B{Ne\-wey yaw\-ne lu oer ul\-te new oe mun\-txa si\-vi poe\-hu. Ru\-txe, ma sem\-pul, tìng mo\-er nge\-yä syawn\-it.} I love Ne\-wey and want to marry her. Please, father, give us your blessing. 
\B{Eywal tivìng ngar sneyä syawnit.} May Ey\-wa bless you. \\
\textsc{ii}.~\B{tìng syawn} \I{[t$\cdot$IN syawn]} \emph{vin.} bless.
\B{Eywa ti\-vìng syawn ngar, ma 'i\-te.} May Ey\-wa bless you, my daughter.~\emph{all} \LINK{http://naviteri.org/2018/03/100a-liu-amip-64-new-words-part-1/}{b}
...
% syaksyuk
\hi
\HT{syaksyuk}{\B{syak\cp{syuk}}} \I{[sjak\textcorner."{}sjuk\textcorner]} \emph{or} \I{[."{}sjUk\textcorner]} \emph{n., fauna} prolemuris, \emph{prolemuris noctis}.
...
\B{Rìk a\-'aw syar\-mar sìn kxem\-yo.} A leaf was sticking to the wall.
\B{Pol kxum\-pay\-syar\-it so\-lar syey\-kar rìk\-it sìn kxem\-yo.} She stuck the leaf onto the wall with glue. [lit.: ``She used glue (and then) stuck the leaf onto the wall.''] \emph{both}~\LINK{http://naviteri.org/2020/11/vospxivopeya-ayliu-amip-novembers-new-words/}{b} \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIsyImawnun'i}{\B{tì\-syì\-maw\-nun\-'i}}, independence. 
...
% syokup
\hi 
\HT{syokup}{\B{syo\cp{kup}}} \I{[sjo."kup\textcorner]} \emph{or} \I{[."kUp\textcorner]} \emph{n.} weight (physical). 
...
\B{Tsran\-ten fra\-to a syon tsam\-si\-yu\-ä lu tì\-tstew.} The most important characteristic of a warrior is bravery.  
\B{Pa\-lu\-lu\-kan\-ìri lu pxe\-syon a ze\-ne fko zi\-ve\-rok nì\-tut.} Three things about the thanator must always be kept in mind.
\B{Fra\-'u\-ä ran ngä\-pop fa fra\-syon tse\-yä.} The \emph{ran} of each thing arises from the totality of its attributes.~\emph{all}~\LINK{http://naviteri.org/2012/10/mipa-vospxi-mipa-ayliu-new-words-for-the-new-month/}{b} \\
...
\B{Syor, ma 'ey\-lan, syor. Ke lu kea sngum\-tsim.} Relax, friend, relax. There's nothing to worry about.
\B{New oe ri\-vun a\-sim tì\-fnu\-nga'\-a tseng\-it a tsa\-ro tsun syi\-vor tsi\-vu\-rokx fte spä\-pi\-veng.} I want to find a quiet place nearby where I can chill out and rest to get my head back on straight.
\B{Fì\-u\-van\-ìl oe\-ti syey\-kor nì\-txan.} I find this game very relaxing.~\emph{all}~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}{b} \\
\on{1}.~\HL{tIsyor}{\B{tìsyor}}, relaxation.
...
\B{Fì\-syu\-lang\-it syam. Fa\-hew lor lu nì\-txan, ke\-fyak?} Smell this flower. Its fragrance is beautiful, isn't it?~\LINK{http://naviteri.org/2012/11/renu-ayinanfyaya-the-senses-paradigm/}{b}
(i.) \B{sä\-star\-sìm syu\-lang\-ä}, bouquet (\emph{collection of flowers selected and put together intentionally by a person}).~\LINK{http://naviteri.org/2012/03/spring-vocabulary-part-2/}{b} \\
\on{1}.~\HL{prrnesyul}{\B{prrnesyul}}, bud (of a flower).
...
% syusmung
\hi
\HT{syusmung}{\B{\cp{syu}smung}} \I{["{}sju.smuN]} \emph{or} \I{[.smUN]} \emph{n.} tray. 
