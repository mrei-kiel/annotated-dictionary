...
\on{2}.~\HL{pxawpxun}{\B{pxaw\-pun}}, armband. 
...
\textsc{Derivatives}: \ding{43}
\on{1}.~\HL{lepxImrun}{\B{le\-pxìm\-run}}, common, often found.
...
% pxohe
\hi
\HT{pxohe}{\B{\cp{pxo}he}} \I{["p'o.hE]} \emph{pn.} we (three), the three of us (not you) (1\textsuperscript{st} person trial, exclusive; deferential or ceremonial form)
% (\emph{a. subjective})
% (\emph{b. agentive})
% (\emph{c. patientive})
% (\emph{d. genitive})
