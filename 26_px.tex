...
% pxasul
\hi
\HT{pxasul}{\B{\cp{pxa}sul}} \I{["p'a.sul]} \emph{or} \I{[.sUl]} \emph{adj.} fresh, appealing as food.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{pxawpa}{\B{pxawpa}}, perimeter, border. 
\on{2}.~\HL{pxawpun}{\B{pxawpun}}, armband. 
\on{3}.~\HL{pxawngip}{\B{pxawngip}}, environment. 
...
\on{1}.~\HL{nIpxay}{\B{nìpxay}}, many, in great number. \\
\on{2}.~\HL{holpxay}{\B{holpxay}}, number. \\
\on{3}.~\HL{pxayopin}{\B{pxayopin}}, colorful, multi\hyp{}colored. \\
\on{4}.~\HL{pxayzekwA}{\B{pxayzekwä}}, spiny whips.
...
\B{Ye\-rik\-ìl nan\-tang\-it pxo\-lek fte hi\-vi\-fwo.} The hexapede kicked the viperwolf in order to flee.
\B{Po pxun\-fa pxek tsa\-krr me\-fo zup ne\-kll!} He shoved the two of them and they fell down.~\emph{both}~\LINK{http://naviteri.org/2014/05/mipa-ayliu-mipa-aysafpil-new-words-new-ideas/}{b}
...
\on{1}.~\HL{vospxey}{\B{Vospxey}}, March.
...
\on{1}.~\HL{nIpxim}{\B{nìpxim}}, errectly, rightly. 

% pximaw
\hi
\HT{pximaw}{\B{pxi\cp{maw}}} \I{[p'i."maw]} \emph{adv.} right after.
...
% -pxì
\hi
\HT{pxI}{\B{-pxì}} \I{[.p'I]} \emph{num. suf. to form fractions with the base form of nummbers}. 
...
\on{1}.~\HL{lepxìmrun}{\B{lepxìmrun}}, common, often found.

% pxìmun'i
\hi
\HT{pxImun'i}{\B{pxìmun\cp{'i}}} \I{[p'I.m$\cdot$un."P$\cdot$i]} \emph{or} \I{[.mUn.]} \emph{vtr.}\on{23} divide, cut into parts.
...
\on{1}.~\HL{pxorpam}{\B{pxorpam}}, ejective. \\
\on{2}.~\HL{pxorna'}{\B{pxorna'}}, episoth. \\
\on{3}.~\HL{pxorna'lor}{\B{pxorna'lor}}, sari.
...
\on{1}.~\HL{tIpxul}{\B{tìpxul}}, formidableness, imposingness. \\
\on{2}.~\HL{nIpxul}{\B{nìpxul}}, formidably, imposingly.
...
\B{Po\-ri pxun\-pxaw lu pxaw\-pxun.} Around his arm is an armband.~\LINK{http://naviteri.org/2011/08/new-vocabulary-clothing/}{b} \\
\on{1}.~\HL{pxuntil}{\B{pxuntil}}, elbow. \\
\on{2}.~\HL{pxawpxun}{\B{pxawpxun}}, armband.
