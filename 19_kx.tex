...
% kxal
\hi 
\HT{kxal}{\B{kxal}} \I{[k'al]} \emph{adj.} strict, demanding proper behavior. 
\B{Ftum\-fa kxal\-a kar\-yu\-ä kxa za\-'u sä\-nu\-me a ley.} From the mouth of a strict teacher comes valuable instruction.~\LINK{https://naviteri.org/2025/04/mevosinga-liu-amip-twenty-new-words/}{b} \\
\textsc{Derivatives}: \ding{43} 
...
% kxapay / si
\hi 
\HT{kxapay}{\B{\cp{kxa}pay}} \I{["k'a.paj]} \textsc{i}. \emph{n.} spit, saliva. \\
\textsc{ii}. \B{\cp{kxa}pay si} \I{["k'a.paj si]} \emph{vin.} salivate.
(\ding{43}~\HL{kxa}{\B{kxa}}, \HL{pay2}{\B{pay}}) \\
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{kxapaytsre'}{\B{kxa\-pay\-tsre'}}, spit.

% kxapaytsre'
\hi 
\HT{kxapaytsre'}{\B{\cp{kxa}paytsre'}} \I{["k'a.paj.\t{ts}R$\cdot$EP]} \emph{vin., inf.}\on{33} spit (deliberately). 
...
% kxapnga'
\hi
\HT{kxapnga'}{\B{\cp{kxap}nga'}} \I{["k'ap\textcorner.NaP]} \emph{adj., nfp.} threatening.
...
% kxäl
\hi 
\HT{kxAl}{\B{kxäl}} \I{[k'\ae{}l]} \emph{adj.} apathetic, feeling of apathy (\emph{used with} \ding{43}~\HL{'efu}{\B{'efu}}). 
...
% kxew
\hi 
\HT{kxew}{\B{kxew}} \I{[k'Ew]} \emph{intj.} \emph{expression of disappointment or frustration when things don't go as planned} ``Nuts!'', ``Darn!'', ``Damn!''. 
...
% kxìm
\hi
\HT{kxIm}{\B{kxìm}} \I{[k'Im]} \emph{vtr.} command, order, assign a task (\emph{with} \ding{43}~\HL{tsonta}{\B{tson\-ta}}).
...
% kxum
\hi
\HT{kxum}{\B{kxum}} \I{[k'um]} \emph{or} \I{[k'Um]} (\textsc{rn}: \B{kxùm} \I{[gUm]}) \emph{adj.} viscous, gelatinous, thick. \\
\textsc{Derivatives}: \ding{43} \on{1}.~\HL{kxumpay}{\B{kxum\-pay}}, viscous liquid, gel.

% kxumpay
\hi
\HT{kxumpay}{\B{\cp{kxum}pay}} \I{["k'um.paj]} \emph{or} \I{["k'Um.]} (\textsc{rn}: \B{\cp{kxùm}\-pay} \I{["gUm.paj]}) \emph{n.} viscous liquid, gel. 
...
(\ding{43}~\HL{kxum}{\B{kxum}}, \HL{pay2}{\B{pay}}) \\
\textsc{Derivatives}: \ding{43} \on{1}.~\HL{txekxumpay}{\B{txe\-kxum\-pay}}, magma, lava.
\on{2}.~\HL{kxumpaysyar}{\B{kxum\-pay\-syar}}, glue.

% kxumpaysyar
\hi 
\HT{kxumpaysyar}{\B{\cp{kxum}paysyar}} \I{["k'um.paj.sjaR]} \emph{or} \I{["k'Um.]} (\textsc{rn}: \B{\cp{kxùm}paysyar} \I{["gUm.paj.SaR]}) \emph{n.} glue. 
...
% kxutu
\hi
\HT{kxutu}{\B{\cp{kxu}tu}} \I{["k'u.tu]} \emph{n.} enemy. 
