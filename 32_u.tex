...
\B{Oey nan\-tang\-tsyìp o\-lu\-e' ta\-lu\-na yom nì\-hawng.} My dog vomited because it ate too much.
(\emph{b. vtr.}) vomit up. 
\B{Prr\-nen\-ìl wu\-tsot o\-lu\-e'.} The baby vomited up its meal.~\emph{both}~\LINK{http://naviteri.org/2016/06/mrrvola-lifyavi-amip-forty-new-expressions/}{b} 

% uk
\hi
\HT{uk}{\B{uk}} \I{[uk\textcorner]} \emph{or} \I{[Uk\textcorner]} \emph{n.} shadow.
...
\B{Oel ay\-nga\-ti ka\-me\-ie, ma oe\-yä ey\-lan, ul\-te ay\-nga\-ru sei\-yi ira\-yo.} I \textsc{see} you, my friends, and I thank you.  
\B{Kì\-ye\-va\-me ul\-te Ey\-wa nga\-hu.} \textsc{See} you again, and may Ey\-wa be with you.~\emph{both}~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln} 
(\ding{43}~\HL{sI}{\B{sì}})

% ultxa / si
\hi
\HT{ultxa}{\B{ul\cp{txa}}} \I{[ul."t'a]} \emph{or} \I{[Ul.]} \textsc{i}. \emph{n.} meeting.
...
\textsc{ii}. \B{ultxa si} \I{[ul."t'a si]} \emph{vin.} meet (intentionally with s.o., \B{hu}). 
...
% ultxarun
\hi
\HT{ultxarun}{\B{ul\cp{txa}run}} \I{[ul."t'a.R$\cdot$un]} \emph{or} \I{[Ul."t'a.RUn]} \emph{vtr., inf.}\on{33} meet by chance, encounter. 
...
% ultxatu
\hi
\HT{ultxatu}{\B{ul\cp{txa}tu}} \I{[ul."t'a.tu]} \emph{or} \I{[Ul.]} \emph{n.} meeting participant. 
...
% um
\hi
\HT{um}{\B{um}} \I{[um]} \emph{or} \I{[Um.]} \emph{adj.} loose.   
(\ding{214}~\HL{'ekxin}{\B{'ekxin}}) \\
\on{1}.~\HL{'ekxinum}{\B{'ekxinum}}, tightness, looseness.
...
\on{2}.~\HL{uniltIrantokx}{\B{uniltìrantokx}}, dreamwalker body, avatar; (the movie) \emph{Avatar}. 
\on{3}.~\HL{uniltIranyu}{\B{uniltìranyu}}, dreamwalker.
\on{4}.~\HL{uniltsa}{\B{unil\-tsa}}, dream of\slash about. 
...
\on{1}.~\HL{uniltIrantokxolo'}{\B{uniltìrantokxolo'}}, \emph{Avatar} community.
...
(\ding{43}~\HL{uniltIrantokx}{\B{unil\-tì\-ran\-tokx}}, \HL{olo'}{\B{olo'}})
...
\B{Nì\-trr\-trr oel unil\-tsa sa'\-nu\-ä tey\-lut.} I regularly dream of my mom's \emph{teylu}.
\B{Unil\-tso\-la oel txon\-am fu\-ta tsway\-on Ney\-ti\-ri\-hu.} Last night I dreamed I was flying with Neytiri.~\emph{both}~\LINK{http://naviteri.org/2015/03/kap-si-ayunil-saylahe-threats-dreams-and-other-things/}{b}
...
% -ur
\hi
\HT{-ur}{\B{-ur}} \I{[.uR]} \emph{or} \I{[.UR]} \emph{suf.} to mark the dative case of a n. ending in a consonant or the diphthongs ey, ay, aw.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kafiuran}{\B{ka\-fi\-uran}}, sailboat.

% us
\hi
‹\B{us}› \I{[u.s]} \emph{inf. in} pre-‹1› (to form the active participle) 
...
% utral 
\hi
\HT{utral}{\B{\cp{ut}ral}} \I{["ut\textcorner.Ral]} \emph{or} \I{["Ut\textcorner.]} \emph{n.} tree. 
...
\textsc{Derivations}: \on{1}.~\HL{utraltsyIp}{\B{ut\-ral\-tsyìp}}, bush. 
...
% Utral Aymokriyä
\hi
\HT{utral aymokriyA}{\B{\cp{Ut}ral Ay\cp{mok}riyä}} \emph{or} \B{\cp{Ut}raya \cp{Mok}ri} \I{["ut\textcorner.Ral aj."mok\textcorner.Ri.j\ae]} \emph{or} \I{["Ut\textcorner.]} \emph{n.} Tree of Voices (\emph{important spiritual site}).
...
% utraltsyìp 
\hi
\HT{utraltsyIp}{\B{\cp{ut}raltsyìp}} \I{["ut\textcorner.Ral.\t{ts}jIp\textcorner]} \emph{or} \I{["Ut\textcorner.]} \emph{n.} bush. 
...
% uturu
\hi 
\HT{uturu}{\B{u\cp{tu}ru}} \I{[u."tu.Ru]} \emph{n.} sanctuary, place of refuge. 
...
% uy
\hi
‹\B{uy}› \I{[u.j]} \emph{inf. in} ‹2› (to indicate formal or ceremonial speech).   
