...
% zam mì zam
\hi 
\HT{zam mI zam}{\B{zam mì zam}} \I{[zam mI zam]} \emph{adv.} completely, one hundred percent. 
...
% zìsìtnun
\hi 
\HT{zIsItnun}{\B{zìsìt\cp{nun}}} \I{[zI.sIt\textcorner."nun]} \emph{or} \I{[."nUn]}\emph{n.} leap year. 
...
% zìsìtnuntrr
\hi 
\HT{zIsItnuntrr}{\B{zìsìt\cp{nun}trr}} \I{[zI.sIt\textcorner."nun.t\s{r}]} \emph{or} \I{[."nUn.]} \emph{n.} leap year day. 
