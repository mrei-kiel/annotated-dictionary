...
(\emph{b. idiom}) \B{za\-'u nì\-'eng}, share an interest in common. 
...
\textsc{Derivations}: \on{1}.~\HL{emza'u}{\B{emz\-a\-'u}}, pass, overcome.  
...
% zamunge
\hi
\HT{zamunge}{\B{za\cp{mu}nge}} \I{[za."m$\cdot$u.N$\cdot$E]} \emph{vtr., inf.}\on{23} bring.
...
\B{Tsa\-fne\-pam\-tseo ke zaw\-prr\-te' oe\-ne.} I don't enjoy that kind of music.
\B{Sìl\-pey oe tsnì fpom li\-vu ay\-nga\-ru nì\-wotx ul\-te snge\-rä\-'i a zì\-sì\-krr a\-sang zi\-vaw\-prr\-te' ay\-nga\-ne.} I hope that you are all well and that you are enjoying the beginning warm season.~\emph{both}~\LINK{http://naviteri.org/2015/04/some-new-words-for-may-day/}{b}
...
% zäfi
\hi
\HT{zAfi}{\B{\cp{zä}fi}} \I{["z\ae.fi]} \emph{adj.} modified, interfered with, no longer in a natural state; tamed.
\B{Oel yom tsngan\-it a\-zä\-fi nì\-'aw.} I only eat cooked meat.
\B{Tsa\-ik\-ran\-ìri ta\-lun\-a new nga\-ti tspi\-vang, law lu fwa mi ke lu zä\-fi.} Since that ikran wants to kill you, it's clear it's still not tame.~\emph{both}~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}{b}
(\ding{214}~\HL{yrr}{\B{yrr}})

% zärìp
\hi 
\HT{zArIp}{\B{\cp{zä}rìp}} \I{["z\ae.RIp\textcorner]} \emph{vtr.} (\emph{coll. form of}) pull. (\ding{43}~\HL{za'ArIp}{\B{za\-'ä\-rìp}})
...
(\ding{43}~\HL{zekwA}{\B{zekwä}}, \HL{lor}{\B{lor}})
...
(i.) \B{tìng zekwä}, \emph{vin.} (\texttt{+}\emph{control}) touch (intentionally). \B{Rä\-'ä tìng zek\-wä oer!} Don't touch me!
\B{Lu fì\-vul su\-syang nì\-txan. Txo fko ti\-vìng zek\-wä kxakx.} This branch is very fragile. If you touch it, it'll break.~\emph{both}~\LINK{http://naviteri.org/2015/04/some-new-words-for-may-day/}{b} 
...
\B{Zun tom\-pa zì\-ye\-vup trr\-ay, zel fo srì\-ye\-vew.\slash … zel fo srew.} If it rained tomorrow, they'd do a dance.
\B{Zun ay\-oe li\-vu tsam\-si\-yu, zel tsa\-kem ke sim\-vi.} If we were warriors, we wouldn't have done that.~\emph{both}~\LINK{http://naviteri.org/2013/04/zun-zel-counterfactual-conditionals/}{b}
...
\B{Nga ze\-ne ki\-vä.} You must go.
\B{Ke ze\-ne nga ki\-vä.} It's not necessary\slash obligatory that you go.~\emph{both}~\LINK{http://naviteri.org/2011/04/\%E2\%80\%99a\%E2\%80\%99awa-li\%E2\%80\%99fyavi-amip\%E2\%80\%94a-few-new-expressions/}{b} \\
\on{1}.~\HL{zenke}{\B{zen\-ke}}, must not. \\
\on{2}.~\HL{kezemplltxe}{\B{ke\-zem\-pll\-txe}}, of course.

% zenke
\hi
\HT{zenke}{\B{\cp{zen}ke}} \I{["z$\cdot$EN$\cdot$.kE]} \emph{vin., modal} must not. (!\emph{irregular infix distribution with second position infixes}! \B{\cp{ze}\-näng\-ke}, \B{\cp{ze}\-nei\-ke}, \B{\cp{ze}\-nu\-ye\-ke}, \B{\cp{ze}\-na\-tse\-ke} \LINK{http://forum.learnnavi.org/language-updates/affective-obligation-\%28zenke\%29/}{ln})
...
% zeswa
\hi
\HT{zeswa}{\B{\cp{ze}swa}} \I{["zE.swa]} \emph{n.} grass.
...
\B{Pey\-ral\-ìl zet wur\-a wu\-tsot a\-'aw\-nem pxel sngel.} Peyral treats a cool cooked meal like garbage.
\B{Pol zo\-let oe\-yä sä\-fpìl\-it pxel pum a tì\-ngä\-zìk\-it ngop.} He treated my idea as though it created a problem. 
\B{Pol ze\-ret oe\-ti pxel tu\-te a ke inan pot.} He's treating me like I don't know him.
\B{Va'\-rul zä\-nget ik\-ran\-it sn\-eyä pxel ha\-pxì\-tu so\-a\-i\-ä.} Va'ru treats his ikran like a member of the family.~\emph{all}~\LINK{http://naviteri.org/2012/10/mipa-vospxi-mipa-ayliu-new-words-for-the-new-month/}{b}
...
\on{1}.~\HL{tIzevakx}{\B{tìzevakx}}, cruelty. \\
\on{2}.~\HL{nIzevakx}{\B{nìzevakx}}, cruelly.
...
\textsc{Derivations}: \on{1}.~\HL{tIzin}{\B{tì\-zin}}, tanglement. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{zIsItnuntrr}{\B{zì\-sìt\-nun\-trr}}, leap year day.
...
(\emph{a. conversational expressions}) \B{'Uo ke zo srak?\slash 'Uk zo srak?} `Is something wrong?'
\B{'U\-pe ke zo?} `What’s the matter?\slash What's wrong?' \emph{both}~\LINK{http://naviteri.org/2020/07/vospxivol-lefpom-happy-august/}{b}  \\
...
\on{1}.~\HL{zongtseng}{\B{zongtseng}}, safe place, refuge.
\on{2}.~\HL{nIzawnong}{\B{nìzawnong}}, safely.
...
% zum
\hi
\HT{zum}{\B{zum}} \I{[zum]} \emph{or} \I{[zUm]} \emph{n.} object, thing (\emph{physical or tangible}).
...
% zung
\hi 
\HT{zung}{\B{zung}} \I{[zuN]} \emph{or} \I{[zUN]} \emph{vin.} crouch. 
