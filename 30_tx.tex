...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tItxaw}{\B{tì\-txaw}}, punishment.

% txawnulsrung
\hi 
\HT{txawnulsrung}{\B{txaw\cp{nul}srung}} \I{[t'aw."nul.sRuN]} \emph{or} \I{[."nUl.sRUN]} \emph{n.} machine. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{fItxan}{\B{fì\-txan}}, so, this much. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{txanro'tu}{\B{txan\-ro'\-tu}}, famous person, celebrity.
...
\B{Tsa\-tu\-tan la\-yä\-ngu ye'\-rìn eyk\-tan a txan\-tur fra\-to 'Rr\-ta\-mì.} That man will soon be the most powerful leader on Earth.
\B{tu\-té a\-txan\-tur}, a powerful woman.~\emph{both}~\LINK{http://naviteri.org/2016/12/tengkrr-perahem-zisit-amip-as-the-new-year-arrives/}{b}
...
\B{Tì\-ran nì\-fnu txan\-txew\-vay fte\-ke ay\-ye\-rik\-ìl aw\-nga\-ti sti\-vawm.} Walk as quietly as possible so the hexapedes won't hear us.
\B{Ay\-nga\-ri ftxo\-zä Hä\-lo\-win\-ä li\-vu 'o' sì snew\-sye txan\-txew\-vay.} May your Halloween be as fun and spooky as possible.~\emph{both}~\LINK{http://naviteri.org/2012/10/snewsyea-ftxoza-halowina-a-spooky-halloween/}{b}
...
\on{1}.~\HL{tItxantslusam}{\B{tìtxantslusam}}, wisdom.
...
\on{1}.~\HL{txanwetseng}{\B{txanwetseng}}, personally significant or beloved place, \emph{heimat}.
...
\on{1}.~\HL{nItxay}{\B{nìtxay}}, horizontally. \\
\on{2}.~\HL{klltxay}{\B{klltxay}}, lie on the ground. \\
\on{3}.~\HL{txayo}{\B{txayo}}, field, plain.
...
\on{1}.~\HL{meitayo}{\B{meitayo}}, wetlands.
...
\on{1}.~\HL{snatxArem}{\B{snatxärem}}, skeleton. \\
\on{2}.~\HL{txArpawk}{\B{txärpawk}}, Palulukan Bone Horn.

% txärpawk
\hi
\HT{txArpawk}{\B{\cp{txär}pawk}} \I{[t'\ae{}R.pawk\textcorner]} \emph{n.} Palulukan Bone Horn.
...
\on{2}.~\HL{txe'lankong}{\B{txe'lankong}}, heartbeat.
...
% txekxumpay
\hi
\HT{txekxumpay}{\B{txe\cp{kxum}pay}} \I{[t'E."k'um.paj]} \emph{or} \I{[."k'Um.]} \emph{n.} magma, lava.
...
\on{1}.~\HL{tItxen}{\B{tìtxen}}, awakeness.
...
\textsc{Derivations}: \on{1}.~\HL{txepIva}{\B{txe\-pì\-va}}, ash, cinder. 
...
(\ding{43}~\HL{txep}{\B{txep}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{txepvispxam}{\B{txep\-vispxam}}, sparkle pod. 

% txepvispxam
\hi 
\HT{txepvispxam}{\B{\cp{txep}vispxam}} \I{["t'Ep\textcorner.vi.sp'am]} \emph{n.} \ding{96} sparkle pod. 
(\ding{43}~\HL{txepvi}{\B{txepvi}}, \HL{spxam}{\B{spxam}}) 
...
(\emph{a. idiom}) \B{Ke tsun aw\-nga pi\-vey nul\-krr--txew lok.} We can't wait any longer--time is almost up.~\emph{all}~\LINK{http://naviteri.org/2012/03/spring-vocabulary-part-1/}{b} \\
\textsc{Derivations}: \on{1}.~\HL{txewluke}{\B{txew\-luke}}, endless, boundless. 
...
% txewk
\hi
\HT{txewk}{\B{txewk}} \I{[t'Ewk\textcorner]} \emph{n.} club (\emph{weapon}). 
...
\textsc{Derivations}: \on{1}.~\HL{letxi}{\B{le\-txi}}, hurried, frenzied. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{naritxim}{\B{na\-ri\-txim}}, eyethorn.
...
\on{1}.~\HL{txintIn}{\B{txintìn}}, occupation. 
\on{2}.~\HL{txintseng}{\B{txintseng}}, base of operations.
...
(\ding{43}~\HL{txintseng}{\B{txintseng}}, \HL{tawtute}{\B{taw\-tu\-te}})
...
\B{Tì\-tu\-sa\-ron\-ìri txo new fko sli\-vu tsul\-fä\-tu, ze\-ne smar\-to li\-vu wa\-lak.} If you want to become a master hunter, you have to be more active than your prey.
\B{Txo new nga tsli\-vam, ze\-ne ki\-van\-fpìl.} If you want to understand, you have to concentrate.~\emph{both}~\LINK{http://naviteri.org/2011/10/more-vocabulary-a-bit-of-grammar/}{b}
...
\B{Swey\-lu txo ki\-vä.} I\slash you\slash she\slash one\slash etc. should go.~\emph{all}~\LINK{http://naviteri.org/2011/04/\%E2\%80\%99a\%E2\%80\%99awa-li\%E2\%80\%99fyavi-amip\%E2\%80\%94a-few-new-expressions/}{b}
...
(\ding{43}~\B{zun}) \\
\textsc{Derivations}: \on{1}.~\HL{txokefyaw}{\B{txokefyaw}}, if not, or else, otherwise.
\on{2}.~\HL{mungwrrtxo}{\B{mungwrrtxo}}, unless, except if.
\on{3}.~\HL{txotsafya}{\B{txotsafya}}, if that's the case.
...
\on{1}.~\HL{hItxoa}{\B{hìtxoa}}, excuse me, pardon me. \\
\on{2}.~\HL{ngaytxoa}{\B{ngaytxoa}}, forgive me, sorry. 
...
(i.) \B{txo\cp{nam}} \I{[t'o."nam]} \emph{adv.} last night. \B{Txon\-am teng\-krr tar\-mì\-ran oe kxam\-lä na'\-rìng, sro\-ler eo ut\-ral a\-tsawl txewm\-a vrr\-tep.} Last night as I was walking through the forest, a frightening demon appeared in front of a big tree.~\LINK{http://naviteri.org/2012/03/spring-vocabulary-part-1/}{b} \\
(ii.) \B{txo\cp{nay}} \I{[t'o."naj]} \emph{adv.} tomorrow night. \\  
...
(i.) \B{txon'o\cp{ngay}} \I{[t'on.Po."Naj]} tomorrow's nightfall\slash sunset. \B{Ul\-txa si\-vi oeng sìn ram\-tsyìp txon\-'ong\-ay.} Let's meet on the hill tomorrow at nightfall.~\LINK{http://naviteri.org/2012/01/mipa-zisit-ayliu-amip-new-words-for-the-new-year/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{txopunil}{\B{txo\-pu\-nil}}, nightmare.
...
% txukx
\hi
\HT{txukx}{\B{txukx}} \I{[t'uk']} \emph{or} \I{[t'Uk']} (\textsc{rn}: \B{txukx} \I{[duk']}) \emph{adj.} (\emph{a. physical}) deep. 
\B{kil\-van a\-reng}, a shallow river.
(\emph{b. metaphorically for thoughts, ideas, analyses, etc.}) deep, thorough. 
\B{Ay\-sä\-fpìl a\-txukx.} Deep thoughts.~\emph{both}~\LINK{http://naviteri.org/2010/07/vocabulary-update/}{b} 
...
\textsc{Derivations}: \on{1}.~\HL{nItxukx}{\B{nì\-txukx}}, deeply.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tItxukxefu}{\B{tì\-txu\-kxe\-fu}}, care, concern. 
...
% txum
\hi
\HT{txum}{\B{txum}} \I{[t'um]} \emph{or} \I{[t'Um]} \emph{n.} poison. 
...
% txumnga'
\hi
\HT{txumnga'}{\B{\cp{txum}nga'}} \I{["t'um.NaP]} \emph{or} \I{["t'Um.]} \emph{adj.} poisonous.
(\ding{43}~\HL{txum}{\B{txum}}, \HL{-nga'}{\B{-nga'}})

% txumpaywll
\hi
\HT{txumpaywll}{\B{\cp{txum}paywll}} \I{["t'um.paj.w\s{l}]} \emph{or} \I{["t'Um.]} \emph{n.}, \ding{96} scorpion thistle, ``poison water plant'', \emph{scorpioflora maxima}. 
(\ding{43}~\HL{txum}{\B{txum}}, \HL{pay}{\B{pay}}, \HL{'ewll}{\B{'ewll}})

% txumtsä'wll
\hi
\HT{txumtsA'wll}{\B{\cp{txum}tsä'wll}} \I{["t'um.\t{ts}\ae{}P.w\s{l}]} \emph{or} \I{["t'Um.]} \emph{n.}, \ding{96} baja tickler, ``poison squirt plant'', \emph{flaska reclinata}. 
...
\B{Fì\-sä\-spxin\-ìl ke txa\-yung aw\-ngey sì\-rey\-ti tì\-'i'\-a\-vay krr\-ä.} This illness will not disrupt our lifes forever.
\B{Oey fpom\-it txung rä\-'ä!} Don't bother me! \emph{both}~\LINK{http://naviteri.org/2020/03/teri-tifkeytok-lefkrr-about-the-present-situation/}{b} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tItxur}{\B{tì\-txur}}, strength. 
