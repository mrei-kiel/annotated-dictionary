...
% txampay
\hi
\HT{txampay}{\B{\cp{txam}pay}} \I{["t'am.paj]} \emph{n.} sea, ocean. 
...
(\ding{43}~\HL{txan}{\B{txan}}, \HL{pay2}{\B{pay}}) \\
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{txampaysAtsa}{\B{txam\-pay\-sä\-tsa}}, seascape.

% txampaysätsa
\hi 
\HT{txampaysAtsa}{\B{\cp{txam}paysätsa}} \I{["t'am.paj.s\ae.\t{ts}a]} \emph{n.} seascape. 
...
% txanley
\hi 
\HT{txanley}{\B{\cp{txan}ley}} \I{["t'an.l$\cdot$Ej]} \emph{vin., inf.}\on{22} be invaluable. 
...
% txanro'tu
\hi 
\HT{txanro'tu}{\B{txan\cp{ro'}tu}} \I{[t'an."RoP.tu]} \emph{n.} famous person, celebrity. 
...
% txepìva
\hi
\HT{txepIva}{\B{\cp{txe}pìva}} \I{["t'E.pI.va]} \emph{n.} ash, cinder; \emph{shortened form:}~\ding{43} \HL{txeva}{\B{txe\-va}}.
...
% txeva
\hi 
\HT{txeva}{\B{\cp{txe}va}} \I{["t'E.va]} \emph{n.} ash (\emph{shortened form of:} \ding{43}~\HL{txepIva}{\B{txe\-pì\-va}}). 
...
% txewnga'
\hi
\HT{txewnga'}{\B{\cp{txew}nga'}} \I{["t'Ew.NaP]} \emph{adj.} having a limit, not without bounds, finite.
...
% txong
\hi 
\HT{txong}{\B{txong}} \I{[t'oN]} \emph{n.} Windtrader airship. 
...
(\ding{43}~\HL{txum}{\B{txum}}, \HL{pay2}{\B{pay}}, \HL{'ewll}{\B{'ewll}})
...
% txurplltxe
\hi 
\HT{txurplltxe}{\B{\cp{txur}plltxe}} \I{["t'uR.p\s{l}.t'E]} \emph{or} \I{["t'UR.]} \emph{v., inf.}\on{23} declare.
