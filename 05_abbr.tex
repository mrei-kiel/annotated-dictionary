...
References \\
  \textsc{\cb{a}}\slash \textsc{\cb{a\on{2}}}\slash \textsc{\cb{a\on{3}}} & = & line appears in the movie \emph{Avatar} (\on{2009})\slash \emph{Avatar: The Way of Water} (\on{2022})\slash \emph{Avatar: Fire and Ash} (\on{2025}) \\
