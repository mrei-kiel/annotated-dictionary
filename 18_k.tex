...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kalintu}{\B{ka\-lin\-tu}}, sweet person.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tstunlan}{\B{tstun\-lan}}, kind\hyp{}hearted.
...
% ketstun
\hi 
\HT{ketstun}{\B{ke\cp{tstun}}} \I{[kE."\t{ts}tun]} \emph{or} \I{[."\t{ts}tUn]} \emph{adj.} unkind, emotionally cold. 
