...
\B{Kal\-txì si\-vi, ma Ìstaw.} Say hello, Ìstaw.~\LINK{http://naviteri.org/2010/09/getting-to-know-you-part-1/}{b} 
...
% kame
\hi
\HT{kame}{\B{\cp{ka}me}} \I{["ka.mE]} \emph{vtr.} see (\emph{spiritual sense}), acknowledge, see into, understand, connect. \B{Oel nga\-ti ka\-me\-i\-e.} I \textsc{see} you.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#UGO_Movie_Blog}{wiki} 
\B{Sä\-ru\-'u a ka\-me.} A seeing glance.~\LINK{https://naviteri.org/2026/06/tskxekeng-a-mikyunfpi-pamrel-listening-exercise-text/}{b}
(\emph{a. idiom}) \B{Kì\-ye\-vame.} Good-bye. \textsc{See} you soon.~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln}
