...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{krrka}{\B{krr\-ka}}, during.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kaifuran}{\B{ka\-fi\-u\-ran}}, sailboat. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkanhena}{\B{tì\-ka\-hena}}, transportation (abstract). 
...
\textsc{Derivations}: \on{1}.~\HL{nIkakan}{\B{nì\-ka\-kan}}, roughly.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkakmokri}{\B{tì\-kak\-mok\-ri}}, muteness.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkakpam}{\B{tì\-kak\-pam}}, deafness.

% kakrel
\hi
\HT{kakrel}{\B{kak\cp{rel}}} \I{[kak\textcorner."REl]} \emph{adj.} blind. 
(\ding{43}~\HL{rel}{\B{rel}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkakrel}{\B{tì\-kak\-rel}}, blindness.

% kali'weya
\hi
\HT{kali'weya}{\B{kali'\cp{wey}a}} \I{[ka.liP."wEj.a]} \emph{n., fauna} species of poisonous arachnid, \emph{scorpiosista virosae}. \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kalweyaveng}{\B{kal\-we\-ya\-veng}}, `son of a bitch'.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkan}{\B{tì\-kan}}, aim, goal, purpose, target. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sAkanom}{\B{sä\-ka\-nom}}, s.t.~acquired, an acquisition, a possession.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkanu}{\B{tì\-ka\-nu}}, intelligence.  
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{karyu}{\B{ka\-ryu}}, teacher. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkara}{\B{tì\-ka\-ra}}, resistance. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{karyunay}{\B{kar\-yu\-nay}}, apprentice teacher.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkatIng}{\B{tì\-ka\-tìng}}, distribution. 
...
(\ding{43}~\HL{ke}{\B{ke}}, \HL{omum}{\B{omum}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkawng}{\B{tì\-kawng}}, evil. 
...
% kä-
\hi
\B{kä-} \I{[k\ae.]} \emph{not productive part., pref.~to mean} away from, out.  \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kA'ArIp}{\B{kä\-'ä\-rìp}}, push. 
\on{2}.~\HL{kAmakto}{\B{kä\-mak\-to}}, ride out.   
\on{3}.~\HL{kApxI}{\B{kä\-pxì}}, rear.   
\on{4}.~\HL{kAsrIn}{\B{kä\-srìn}}, lend.
\on{5}.~\HL{kAsatseng}{\B{kä\-sa\-tseng}}, out there.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kAteng} {\B{kä\-teng}}, spend time with.     
...
(\ding{214}~\HL{za'ArIp}{\B{za\-'ä\-rìp}}) 
...
(\ding{43}~\HL{munge}{\B{mu\-nge}}, \ding{214}~\HL{zamunge}{\B{za\-mu\-nge}})
...
(\ding{214}~\HL{zasrIn}{\B{za\-srìn}}) 

% käteng
\hi
\HT{kAteng}{\B{\cp{kä}teng}} \I{["k$\cdot$\ae.tEN]} \emph{vin., inf.}\on{11} spend time, hang out (with, \B{hu}). 
...
(\ding{43}~\HL{tsatseng}{\B{tsa\-tseng}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{ke'aw}{\B{ke\-'aw}}, divided, torn apart. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkeftxo}{\B{tì\-ke\-ftxo}}, sadness. 
...
% kehe
\hi
\HT{kehe}{\B{\cp{ke}he}} \I{["kE.hE]} \emph{adv.} no. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kesran}{\B{ke\-sran}}, mediocre. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\B{nì\-kel\-kin}, unnecessarily.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kelutral}{\B{Ke\-lut\-ral}}, Hometree.  
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{txankeltrrtrr}{\B{txan\-kel\-trr\-trr}}, extraordinary.
...
\textsc{ii}. \HT{kem si}{\B{kem si}} \I{[kEm si]} \emph{vin.} do (an action).   \B{Kem si li trr\-ay\-sre.} Do it by tomorrow.~\LINK{http://naviteri.org/2011/02/new-vocabulary-part-2/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kempe}{\B{kem\-pe\slash pe\-hem}}, what (action). 
\on{2}.~\HL{tIkangkem}{\B{tì\-kang\-kem}}, work.  
\on{3}.~\HL{fekem}{\B{fe\-kem}}, accident. 
\on{4}.~\HL{kemlI'u}{\B{kem\-lì\-'u}}, verb. 
\on{5}.~\HL{kawngkem}{\B{kawng\-kem}}, evil deed, crime.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kemlI'uvi}{\B{kem\-lì\-'u\-vi}}, infix.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kemuianga'}{\B{ke\-mu\-ia\-nga'}}, dishonorable.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkemwiA}{\B{tì\-kem\-wiä}}, unfairness, injustice.
\on{2}.~\HL{leymkem}{\B{leym\-kem}}, protest.

% ken
\hi 
\HT{ken}{\B{ken}} \I{[kEn]} \emph{adp.} despite, in spite of. 
...
\B{Fay\-hem\-ìl pe\-yä ke ke\-nong tì\-sayt a fkol fngo' po\-ta.} These actions of his do not represent the loyalty that is required of him.~\LINK{http://naviteri.org/2022/01/aawa-tipangkxotsyip-a-teri-horen-lifyaya-a-few-little-discussions-about-grammar/}{b}
 \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkenong}{\B{tì\-ke\-nong}}, example.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIksran}{\B{nìk\-sran}}, in a mediocre manner.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIketeng}{\B{tì\-ke\-teng}}, difference.
...
% ketsuk-
\hi
\HT{ketsuk}{\B{ketsuk-}} \I{[kE.\t{ts}uk\textcorner.]} \emph{or} \I{[.\t{ts}Uk\textcorner.]} \emph{prod. pref. on vtr. to form receptive ability, that s.t. is not capable of receiving the action of the verb}, ``un-…-able''. \B{ke\-tsuk\-tswa'}, unforgettable.~\LINK{http://naviteri.org/2011/03/\%E2\%80\%9Creceptive-ability\%E2\%80\%9D-and-hesitation/}{b} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{keyrel}{\B{key\-rel}}, facial expression.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{keynven}{\B{keyn\-ven}}, step.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{ketuwong}{\B{ke\-tu\-wong}}, alien.
...
% kezin
\hi 
\HT{kezin}{\B{\cp{ke}zin}} \I{["kE.zin]} \emph{adj.} untangled. (\ding{214}~\HL{zin}{\B{ke\-zin}}) \\
\textsc{Derivations}: \on{1}.~\HL{tIkezin}{\B{tì\-ke\-zin}}, s.t. in an untangled state; solution.
...
\textsc{Derivations}: \on{1}.~\HL{kiantu}{\B{ki\-an\-tu}}, blameworthy person.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{fkeytok}{\B{fkey\-tok}}, exist.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIkin}{\B{tì\-kin}}, (the) need. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kinamtil}{\B{ki\-nam\-til}}, knee.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kintrr}{\B{kin\-trr}}, (\on{7}-day) week. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\B{kintrr\cp{am}} \emph{n., adv.}~last week. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{fkip}{\B{fkip}}, up among. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIk'ong}{\B{nìk\-'ong}}, slowly.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIkmar}{\B{nìk\-mar}}, convenient, in time.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lI'ukIng}{\B{lì\-'u\-kìng}}, sentence.
...
% kllkä
\hi
\HT{kllkA}{\B{kll\cp{kä}}} \I{[k\s{l}."k$\cdot$\ae]} \emph{vin., inf.}\on{22} (\emph{a.}) go down, descend. (\emph{b. for astronomical bodies setting})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nekll}{\B{ne\-kll}}, see below.
...
\textsc{Derivations}: \ding{43} \on{1}.~\B{kll\-txey\-kay}, lay (s.t.) on the ground.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kllvawmpin}{\B{kll\-vawm\-pin}}, (the) brown (color).

% kllvawmpin
\hi
\HT{kllvawmpin}{\B{\cp{kll}vawmpin}} \I{["k\s{l}.vawm.pin]} \emph{n.} the color \B{kll\-vawm}.
(\ding{43}~\HL{kllvawm}{\B{kll\-vawm}}, \HL{'opin}{\B{'o\-pin}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{ko'onspul}{\B{ko\-'on\-spul}}, sunflower gigantus.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{koaktu}{\B{ko\-ak\-tu}}, old person. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{koaktutral}{\B{ko\-ak\-tut\-ral}}, goblin thistle.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{slAkop}{\B{slä\-kop}}, but also.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lekoren}{\B{le\-ko\-ren}}, lawlike, regarding rules. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIksman}{\B{nìk\-sman}}, wonderfully.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{ko'on}{\B{ko\-'on}}, ring, oval, closed shape roughly circular. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{frakrr}{\B{fra\-krr}}, always. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{syokup}{\B{syo\-kup}}, weight.
...
\B{Lo\-lu ka\-vuk, slä Tse\-nul tì\-ngay\-it ko\-lu\-lat.} There was treachery, but Tsenu revealed the truth.~\LINK{http://naviteri.org/2011/10/more-vocabulary-a-bit-of-grammar/}{b} \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kllkulat}{\B{kll\-ku\-lat}}, dig out.
...
More helpful actions lead to less troubling outcomes.~\LINK{http://naviteri.org/2015/03/kap-si-ayunil-saylahe-threats-dreams-and-other-things/}{b} \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kuma}{\B{ku\-ma\slash a\-kum}}, that (\emph{as a result}). 
...
% kunsìp
\hi
\HT{kunsIp}{\B{\cp{kun}sìp}} \I{["kun.sIp\textcorner]}~\emph{or}~\I{["kUn.]} \emph{n.} \textsc{lw} gunship. 
...
% kung
\hi 
\HT{kung}{\B{kung}} \I{[kuN]} \emph{or} \I{[kUN]} \emph{adj.} putrid, fetid, rotten (\emph{referred to rotten meat or a pile of dead and rotting animal matter}). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kurkung}{\B{kur\-kung}}, asshole (\emph{insult}).

% kur
\hi
\HT{kur}{\B{kur}} \I{[kuR]} \emph{or} \I{[kUR]} \emph{vin.} hang (\HL{ta}{\B{ta}}, from).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{keykur}{\B{key\-kur}}, hang (s.t.), let hang. 
...
% kurfyan
\hi
\HT{kurfyan}{\B{\cp{kur}fyan}} \I{["kuR.fjan]} \emph{or} \I{["kUR.]} \emph{n.} hamper, suspended rack.
(\ding{43}~\HL{kur}{\B{kur}}, \HL{fyan}{\B{fyan}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{snokfyan}{\B{snok\-fyan}}, personal belongings rack. 
\on{2}.~\HL{kurfyavi}{\B{kur\-fya\-vi}}, hook.

% kurfyavi
\hi
\HT{kurfyavi}{\B{\cp{kur}fyavi}} \I{["kuR.fja.vi]} \emph{or} \I{["kUR.]} \emph{n.} hook (\emph{for hanging or suspending an item}).
(\ding{43}~\HL{kurfyan}{\B{kur\-fyan}})

% kurkung
\hi 
\HT{kurkung}{\B{\cp{kur}kung}} \I{["kuR.kuN]} \emph{or} \I{["kUR.kUN]} \emph{n.}, \textsc{vulg.} asshole (\emph{strong insult}). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kurkung}{\B{kur\-kung}}, asshole (\emph{strong insult}). 
