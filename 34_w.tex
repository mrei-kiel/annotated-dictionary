...
\B{Ftu\-e lu fwa ta\-ron ngong\-a io\-ang\-it to fwa ta\-ron pum\-it a lu wa\-lak sì win.} It's easier to hunt lethargic animals than to hunt perky, speedy ones.~\emph{both}~\LINK{http://naviteri.org/2011/10/more-vocabulary-a-bit-of-grammar/}{b}
(\ding{214}~\HL{ngong}{\B{ngong}})

% walew
\hi 
\HT{walew}{\B{wa\cp{lew}}} \I{[wa."lEw]} \emph{vin.} get over, accept some fact, reconcile oneself, move on. 
\B{Fu\-ri\-a oe yaw\-ne ke lu Va'\-rur nul\-krr, ke tsä\-ngun oe wi\-va\-lew.} I can't get over the fact that Va'ru no longer loves me.
\B{Tì\-ska\-'a\-ri Kel\-ut\-ral\-ä Na'\-vi wa\-ya\-lew pe\-fya?} With the destruction of Hometree, how will the Na’vi ever move on?~\emph{both}~\LINK{http://naviteri.org/2018/07/ta-sulfatu-a-ayliu-niul-more-words-from-our-experts/}{b}
...
\B{Nga\-ri wa\-we fì\-vur\-ä lu 'u\-pe?} What is the significance of this story to you?
\B{Wa\-we\-ti ke tsun fko ral\-pi\-veng.} One can't explain (or: put into words) \emph{wawe}.~\emph{both}~\LINK{http://naviteri.org/2011/05/some-miscellaneous-vocabulary/}{b} 
...
\textsc{ii}. \B{way si} \I{[waj si]} \emph{vtr.} sing (singing of ancient, traditional song) \\
...
\B{Ya\-ri som\-wew\-pe (set)? Ya lu wew.} What's the temperature? It's cold.
\B{Nga tsun ni\-väk wew\-a pay\-it.} You can drink cold water.~\emph{both}~\LINK{http://naviteri.org/2012/10/audio-and-video-learning-materials-for-navi-101/}{b} 
(\ding{214}~\HL{}{\B{som}}) \\
\textsc{Derviations:}
...
\on{1}.~\HL{leweopx}{\B{leweopx}}, wave\hyp{}like.
...
\B{Po lu win fra\-to.} She is the fastest.
\B{Oel tso\-le\-'a fwam\-pop\-it a\-win fra\-to.} I saw the fastest Tapirus.~\emph{both}~\LINK{http://forum.learnnavi.org/language-updates/confirmations-\%28comparisons-gerund\%29/}{ln} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIwin}{\B{nì\-win}}, fast, quickly, rapidly. 
\on{2}.~\HL{winzaw}{\B{win\-zaw}}, arrow deer.

% winzaw
\hi 
\HT{winzaw}{\B{\cp{win}zaw}} \I{["win.zaw]} \emph{n., fauna} arrow deer. 
(\ding{43}~\HL{win}{\B{win}}, \HL{swizaw}{\B{swizaw}}) 
...
\on{1}.~\HL{tIwIngay}{\B{tìwìngay}}, proving (abstract). \\
\on{2}.~\HL{sAwIngay}{\B{säwìngay}}, proof.
...
\B{Wou Ney\-ti\-ri!} Neytiri is awesome! 
\B{Oe\-ru wo\-eiu lì'\-fya le\-Na'\-vi.} I'm just fascinated by the Na'vi language.
\B{Mì na'\-rìng Tsyeyk\-ìl lo\-re\-yu\-ti 'o\-lam\-pi a tsa\-swaw wou oer nì\-wotx!} That instant when Jake touched the \emph{Helicoradiam Spirale} in the forest I was totally amazed.
\B{Por war\-mou fra\-fne\-i\-o\-ang nì\-tut, slä nì\-pxi pxe\-syì\-rä\-fì.} He just couldn't get over all the animals, but was especially taken with the three giraffe.~\emph{all}~\LINK{http://forum.learnnavi.org/language-updates/txelanit-hivawl/}{ln}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tawrrpa}{\B{ta\-wrr\-pa}}, external.
...
% wum
\hi 
\HT{wum}{\B{wum}} \I{[wum]} \emph{or} \I{[wUm]} \emph{adv.} approximately, roughly.
