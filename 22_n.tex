...
(\emph{d. expression}) \B{nì\-win na hu\-fwe}, ``as fast as the wind'' (\emph{any situation to express rapidity}). \B{na hu\-fwe}, fluent (not just rapid) use of language.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lena'vi}{\B{le\-Na'\-vi}}, having to do with the Na'\-vi. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nantangtsyIp}{\B{nantangtsyìp}}, dog.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{narlor}{\B{nar\-lor}}, (visually) beautiful. 
...
% natkenong 
\hi
\HT{natkenong}{\B{nat\cp{ke}nong}} \I{[nat\textcorner."kE.noN]} \emph{conj.} for example.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tInatxu}{\B{tì\-na\-txu}}, disapproval.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nawmtu}{\B{nawm\-tu}}, great, noble person. 
...
% nawmtoruktek
\hi
\HT{nawmtoruktek}{\B{nawm\cp{to}ruktek}} \I{[nawm."to.Ruk\textcorner.tek\textcorner]} \emph{or} \I{[.rUk.]} \emph{n.} Toruk Makto Totem.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{manawmtu}{\B{ma\-nawm\-tu}}, ``excuse me''.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tInawri}{\B{tì\-naw\-ri}}, talent.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nInAk}{\B{nì\-näk}}, by drinking, in a liquid way.
...
(\ding{214}~\HL{'ul}{\B{'ul}}) \\  
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nInAn}{\B{nì\-nän}}, less.
...
(\emph{b. with} \ding{43}~\HL{za'u}{\B{za\-'u}}) \B{za\-'u nì\-'eng}, share an interest in common. 
...
(\emph{c.}) \B{Zo\-la\-'u nì\-prr\-te' ne pì\-lok.} Welcome to the blog.~\LINK{http://naviteri.org/2010/06/first-post/}{b} 
(\emph{d.}) \B{Ne kll\-te!} ``Get down!'' [lit.: to the ground] 
(\emph{e. with} \ding{43}~\HL{zup}{\B{zup}}) perish. \B{Ke za\-syup Lì\-'o\-na ne kxu\-tu.} The l'Ona will not perish to the enemy. [lit.: will not fall to the enemy]~\LINK{http://forum.learnnavi.org/language-updates/ltasygt-with-ke-and-nga/}{ln\slash g} 
(\emph{f. with} \ding{43}~\HL{kan}{\B{kan}}) aim s.t. at s.t.\slash s.o.
...
(\emph{g. with} \ding{43}~\HL{lonusye}{\B{lo\-nu\-sye}}) blow on.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nefA}{\B{ne\-fä}}, up, upwards.   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{krrnekx}{\B{krr\-nekx}}, take time.
...
% neteyam
\hi 
\HT{neteyam}{\B{Neteyam}} \I{[nE.tE.jam]} \emph{n. male name}. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nulnew}{\B{nul\-new}}, prefer.   
...
% newomum
\hi
\HT{newomum}{\B{new\cp{o}mum}} \I{[n$\cdot$Ew."{}o.mum]} \emph{or} \I{[.mUm]} \emph{vin.}\on{11} be curious. 
(\ding{43}~\HL{new}{\B{new}}, \HL{omum}{\B{omum}}) \\  
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tInomum}{\B{tì\-no\-mum}}, curiosity.   
\on{2}.~\HL{lenomum}{\B{le\-no\-mum}}, curious.

% neympin
\hi
\HT{neympin}{\B{\cp{neym}pin}} \I{["nEjm.pin]} \emph{n.} the color \B{neyn}.
(\ding{43}~\HL{neyn}{\B{neyn}}, \HL{'opin}{\B{'o\-pin}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{neympin}{\B{neym\-pin}}, (the color) \B{neyn}.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{niktsyey}{\B{nik\-tsyey}}, food wrap.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nikroi}{\B{nik\-roi}}, hair ornament.
...
% niktsyey
\hi
\HT{niktsyey}{\B{\cp{nik}tsyey}} \I{["nik\textcorner.\t{ts}jEj]} \emph{adj.} food wrap (\emph{food items wrapped in edible leaves and vines}). 
...
% nitram
\hi
\HT{nitram}{\B{nit\cp{ram}}} \I{[nit\textcorner."Ram]} \emph{adj.} happy (used with \HL{'efu}{\B{'efu}}). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{swaynivi}{\B{sway\-ni\-vi}}, family hammock. 
...
\B{Tsa\-sä\-lä\-txayn Na'\-vi\-ru srung so\-li nì\-'aw fte sli\-vu txur nì\-'ul.} That defeat only helped the People become stronger.~\LINK{http://naviteri.org/2012/01/more-additions-to-the-lexicon/}{b}
(\ding{43}~\HL{'ul}{\B{'ul}}) \\  
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nI'ul'ul}{\B{nì\-'ul\-'ul}}, more and more.
...
% nìawnomum
\hi
\HT{nIawnomum}{\B{nìaw\cp{no}mum}} \I{[nI.aw."no.mum]} \emph{or} \I{[.mUm]}, \emph{in fast speech often} \I{[naw."no.mum]} \emph{adv.} as you know, as is known, as everyone knows.
...
(\ding{43}~\HL{kemweypey}{\B{kem\-wey\-pey}})
...
% nìktungzup
\hi
\HT{nIktungzup}{\B{nìktung\cp{zup}}} \I{[nIk\textcorner.tuN."zup\textcorner]} \emph{or} \I{[.tUN."zUp\textcorner]} \emph{adv.} carefully, firmly (\emph{without letting it fall}).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{zawprrte'}{\B{zaw\-prr\-te'}}, be enjoyable.
...
% nìsung
\hi
\HT{nIsung}{\B{nì\cp{sung}}} \I{[nI."{}suN]} \emph{or} \I{[."{}sUN]} \emph{adv.} besides, additionally, furthermore.
...
% nìtut
\hi
\HT{nItut}{\B{nì\cp{tut}}} \I{[nI."tut\textcorner]} \emph{or} \I{[."tUt\textcorner]} \emph{adv.} continually, continuously, always.
...
(\ding{43}~\HL{txi}{\B{txi}}, \HL{luke}{\B{lu\-ke}})
...
% nìTsyungwen
\hi
\HT{nItsyungwen}{\B{nì\cp{Tsyung}wen}} \I{[nI."\t{ts}uN.wEn]} \emph{or} \I{[."\t{ts}UN.]} \emph{adv.} like the Chinese, in Mandarin.
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{'ongokx}{\B{'o\-ngokx}}, be born.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nongspe'}{\B{nong\-spe'}}, persue with an intend to capture.
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{sAnrr}{\B{sä\-nrr}}, glow, an instance of glowing. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lenrra}{\B{le\-nrra}}, proud, feeling of pride in others. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tInui}{\B{tì\-nui}}, failure (abstract).  
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{numtsengvi}{\B{num\-tseng\-vi}}, classroom.
...
% numultxa
\hi
\HT{numultxa}{\B{numul\cp{txa}}} \I{[nu.mul."t'a]} \emph{or} \I{[.mUl.]} \emph{n.} class (for instruction).   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{numultxatu}{\B{nu\-mul\-txa\-tu}}, classmate, member of a class.

% numultxatu
\hi
\HT{numultxatu}{\B{numul\cp{txa}tu}} \I{[nu.mul."t'a.tu]} \emph{or} \I{[.mUl.]} \emph{n.} classmate, member of a class.
\B{Mì Si\-ä\-tll a nu\-mul\-txa\-ri lì'\-fya\-yä le\-Na'\-vi, sìl\-pey oe slì\-ye\-vu nga nu\-mul\-txa\-tu!} I hope you'll participate in the upcoming Na'vi class in Seattle!~\LINK{http://naviteri.org/2012/07/meetings-waterfalls-and-more/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{zIsItnun}{\B{zì\-sìt\-nun}}, leap year. 
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{flInutx}{\B{flì\-nutx}}, thickness.
