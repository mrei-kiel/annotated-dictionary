...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{lafyon}{\B{la\-fyon}}, wise. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hawtsyIp}{\B{haw\-tsyìp}}, nap. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hamalo}{\B{ha\-ma\-lo}}, last time.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIhah}{\B{tì\-han}}, loss.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hangvur}{\B{hang\-vur}}, joke, funny story.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hapxItu}{\B{ha\-pxì\-tu}}, member.   
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{seysonIltsan}{\B{sey\-so\-nìl\-tsan}}, well done, bravo.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIhawl}{\B{tì\-hawl}}, preparation, plan.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{lehawmpam}{\B{le\-hawm\-pam}}, noisy. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIhawnu}{\B{tì\-haw\-nu}}, protection. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{nIhawng}{\B{nìhawng}}, too, excessively. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{lehawngkrr}{\B{lehawngkrr}}, late (\emph{adj.}).
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hayalo}{\B{ha\-ya\-lo}}, next time.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{sAhe'a}{\B{sä\-he\-'a}}, a cough.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hefitswo}{\B{he\-fi\-tswo}}, sense of smell.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{nIhek}{\B{nì\-hek}}, strangely, oddly.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{sAhena}{\B{sä\-he\-na}}, container, vessel, carrier. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{leheng}{\B{leheng}}, formally polite. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{herwIva}{\B{her\-wì\-va}}, snowflake.  
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{seyn}{\B{seyn}}, chair, stool, bench.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIhipx}{\B{tì\-hipx}}, control.
...
(\emph{b. vtr.}) spit out. \\
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hiupwopx}{\B{hi\-up\-wopx}}, cloud spitter.

% hiupwopx
\hi 
\HT{hiupwopx}{\B{\cp{hi}upwopx}} \I{["hi.up\textcorner.wop']} \emph{n.} \ding{96} cloud spitter. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tsawlhI'}{\B{tsawl\-hì'}}, size. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hImtxan}{\B{hìm\-txan}}, amount. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hImtxampe}{\B{hìm\-txam\-pe}\slash \B{pìm\-txan}}, how much? 

% hìmtxew
\hi
\HT{hImtxew}{\B{hìm\cp{txew}}} \I{[hIm."t'Ew]} \emph{n.} minimum. 
(\ding{214}~\HL{txantxew}{\B{txan\-txew}}) \\
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hItxewvay}{\B{hìm\-txew\-vay}}, minimally.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIhIpey}{\B{tì\-hì\-pey}}, hesitation. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{lehoan}{\B{le\-ho\-an}}, comfortable. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{nIhoet}{\B{nì\-ho\-et}}, widely, pervasively.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{holpxay}{\B{hol\-pxay}}, number.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{nIhona}{\B{nì\-ho\-na}}, sweetly, endearingly.  
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{lehrrap}{\B{le\-hrr\-ap}}, dangerous.     
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{hufwetsyIp}{\B{hu\-fwe\-tsyìp}}, breeze, light wind. 
...
% huru
\hi
\HT{huru}{\B{\cp{hu}ru}} \I{["hu.Ru]} \emph{n.} cooking pod. 
