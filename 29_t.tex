...
\textsc{Derivations}: \ding{43}
\on{1}.~\HL{ketsuktiamti}{\B{ke\-tsuk\-ti\-am}}, uncountable, infinite.
...
\textsc{Derivations}: \ding{43}
\on{1}.~\HL{tIfnugna'}{\B{tì\-fnu\-nga'}}, quiet.
...
% tìrun
\hi
\HT{tIrun}{\B{tì\cp{run}}} \I{[tI."Run]} \emph{or} \I{[."RUn]} (\textsc{rn}: \B{tì\-run} \I{[tI."Run]}) \emph{n.} discovery.
\B{Tì\-run\-ìl tey\-ngä lum\-pe po ho\-lum oe\-ti ke\-ftxo 'ey\-ko\-le\-fu.} The discovery of why he left saddened me.~\LINK{https://naviteri.org/2024/12/odds-and-ends/}{b}
...
(\ding{43}~\HL{tItstunwi}{\B{tì\-tstun\-wi}}, \HL{-nga'}{\B{-nga'}})
...
\on{1}.~\HL{tom\-pa\-meyp}{\B{tom\-pa\-meyp}}, drizzle. 
...
(i.) \B{trr\cp{am}} \I{[t\s{r}."{}am]} \emph{adv., n.} yesterday. 
...
(ii.) \B{trr\cp{ay}} \I{[t\s{r}."{}aj]} \emph{adv., n.} tomorrow. 
