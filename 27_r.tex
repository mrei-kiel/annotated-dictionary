...
% -r
\hi
\HT{-r}{\B{-r}} \I{[R]} \emph{suf. to mark the dative case of a n. ending in a vowel or diphthong}.
(\ding{43}~\HL{-ru}{\B{-ru}}, \HL{-ur}{\B{-ur}})

% ra'un
\hi 
\HT{ra'un}{\B{\cp{ra}'un}} \I{["Ra.Pun]} \emph{or} \I{[.PUn]} \emph{vtr.} surrender s.t., relinquish s.t., give up s.t. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIra'un}{\B{tì\-ra\-'un}}, surrender, relinquishment.
...
\on{1}.~\HL{ralpeng}{\B{ralpeng}}, interpret. \\
\on{2}.~\HL{tafral}{\B{tafral}}, therefore. \\
\on{3}.~\HL{ralnga'}{\B{ralnga'}}, meaningful, instructive. \\
\on{4}.~\HL{ralke}{\B{ralke}}, meaningless, devoid of content.
...
\on{1}.~\HL{tIralpeng}{\B{tìralpeng}}, translation, interpretation.
...
\on{1}.~\HL{ramtsyIp}{\B{ramtsyìp}}, hill. \\
\on{2}.~\HL{txepram}{\B{txepram}}, volcano.
...
\B{Fra\-'u\-ä ran ngä\-pop fa fra\-syon tse\-yä.} The \emph{ran} of each thing arises from the totality of its attributes.
\B{Ran tì\-ru\-sol\-ä pe\-yä lu fyo\-le.} The \emph{ran} of her singing is sublime.
(\emph{b. for people}) personality.
\B{Mun\-txa\-tu\-ri So\-rewn\-ti ke tsun oe mi\-vll\-'an. Ran pe\-yä oe\-ru ke ha'.} I can't accept Sorewn as my spouse. Her personality doesn't suit me.
~\emph{all}~\LINK{http://naviteri.org/2012/10/mipa-vospxi-mipa-ayliu-new-words-for-the-new-month/}{b} \\
\on{1}.~\HL{nIran}{\B{nìran}}, basically, fundamentally, in essence. 
\on{2}.~\HL{loran}{\B{loran}}, elegance, grace. 
...
\textsc{Derivations}: \on{1}.~\HL{nIrangal}{\B{nì\-ra\-ngal}}, ``I wish that …''.
\on{2}.~\HL{sArangal}{\B{sä\-ra\-ngal}}, a wish.

% raspu'
\hi
\HT{raspu'}{\B{ra\cp{spu'}}} \I{[Ra."{}spuP]} \emph{or} \I{[."{}spUP]} \emph{n.} leggings (\emph{used in war}).
...
% rawke
\hi
\HT{rawke}{\B{\cp{raw}ke}} \I{["Raw.kE]} \emph{interj.} alarm cry, call to defense.

% rawm
\hi
\HT{rawm}{\B{rawm}} \I{[Rawm]} \emph{n.} (\emph{of weather}) lightning (\emph{general term}).
(\ding{43}~\HL{atanzaw}{\B{atan\-zaw}})  \\
\on{1}.~\HL{rawmpxom}{\B{rawmpxom}}, thunder and lightning.
...
% räptulì'fya
\hi 
\HT{rAptulI'fya}{\B{räptu\cp{lì'}fya}} \I{[R\ae{}p\textcorner.tu."lIP.fja]} (\textsc{rn}: \B{räptù\cp{lì'}fya} \I{[R\ae{}p\textcorner.tU."lIP.fja]}) \emph{n.} coarse, vulgar language. 
(\ding{43}~\HL{rAptum}{\B{räp\-tum}}, \HL{lI'fya}{\B{lì'\-fya}}) 

% räptulì'u
\hi 
\HT{rAptulI'u}{\B{räptu\cp{lì}'u}} \I{[R\ae{}p\textcorner.tu."lI.Pu]} (\textsc{rn}: \B{räptù\cp{lì}'u} \I{[R\ae{}p\textcorner.tU."lI.Pu]}) \emph{n.} coarse or swear word. 
(\ding{43}~\HL{rAptum}{\B{räp\-tum}}, \HL{lI'u}{\B{lì\-'u}}) 

% räptum
\hi
\HT{rAptum}{\B{räp\cp{tum}}} \I{[R\ae{}p\textcorner."tum]} \emph{or} \I{[."tUm]} (\textsc{rn}: \B{räptùm} \I{[R\ae{}p\textcorner."tUm]}) \emph{adj.} coarse, vulgar, socially unacceptable.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIrAptum}{\B{nì\-räp\-tum}}, coarsly, vulgarly.  
...
\on{1}.~\HL{hawre'}{\B{hawre'}}, hat. \\
\on{2}.~\HL{zare'}{\B{zare'}}, forehead, brow. 
...
\on{1}.~\HL{reltseotu}{\B{reltseotu}}, artist.
...
\on{1}.~\HL{renulke}{\B{renulke}}, irregular, random. \\  
\on{2}.~\HL{rengop}{\B{rengop}}, design (finer detail). \\  
\on{3}.~\HL{renu ngampamA}{\B{renu ngampamä}}, rhyme scheme.
...
\on{1}.~\HL{sArengop}{\B{särengop}}, design. \\
\on{2}.~\HL{tIrengop}{\B{tìrengop}}, design (abstract concept).
...
\on{1}.~\HT{rewonay}{\B{rewo\cp{nay}}} \I{[RE.wo."naj]} \emph{n.; adv.} tomorrow morning.   
...
\on{2}.~\HT{rewonam}{\B{rewo\cp{nam}}} \I{[RE.wo."nam]} \emph{n.; adv.} yesterday morning. 
...
\on{1}.~\HL{lereyfya}{\B{lereyfya}}, cultural.
...
\on{1}.~\HL{reypaytun}{\B{reypaytun}}, red. 
...
\on{1}.~\HL{'ampirikx}{\B{'ampirikx}}, leaf pitcher plant. \\
\on{2}.~\HL{kllrikx}{\B{kllrikx}}, earthquake. \\
\on{3}.~\HL{rel arusikx}{\B{rel a\-ru\-sikx}}, movie, film, video.

% rim
\hi
\HT{rim}{\B{rim}} \I{[Rim]} \emph{adj.} yellow.   
\B{Fì\-syu\-lang lu rim.} This flower is yellow.
\B{Fì\-syu\-lang a\-rim lu hì\-'i fra\-to.} This yellow flower is the smallest of all.
\B{rim na na\-ri}, the yellow of a Na'vi eye.~\emph{all} \LINK{http://naviteri.org/2010/08/mipa-ayopin-mipa-ayliu-new-colors-new-words/}{b} \\
\on{1}.~\HL{nIrim}{\B{nìrim}}, in yellow. \\
\on{2}.~\HL{rimpin}{\B{rimpin}}, the color yellow. 

% rimpin
\hi
\HT{rimpin}{\B{\cp{rim}pin}} \I{["Rim.pin]} \emph{n.} the color yellow.
...
(\ding{43}~\HL{rim}{\B{rim}}, \HL{'opin}{\B{'opin}})
...
\on{1}.~\HL{atokirina'}{\B{atokirina'}}, seeds of the great tree, woodsprite. \\  
\on{2}.~\HL{tsyorina'wll}{\B{tsyorina'wll}}, cycad.
...
\B{ay\-nan\-tang sì ay\-ri\-ti} \emph{pronounced:} \I{[aj."nan.taN saj."Ri.ti]}, viperwolfs and stingbats.~\LINK{http://naviteri.org/2010/07/thoughts-on-ambiguity/}{b}
...
\on{1}.~\HL{lerIk}{\B{lerìk}}, leafy. \\  
\on{2}.~\HL{rIkean}{\B{rìkean}}, leaf\hyp{}green.
...
\on{1}.~\HL{nIrIkxi}{\B{nìrìkxi}}, shakily, tremblingly.
...
\B{ro fä\-pa}, at the top. 
\B{ro hel\-ku}, at home.~\emph{both}~\LINK{http://forum.learnnavi.org/language-updates/all-adpositions/msg137792/\#msg137792}{ln}
...
\on{1}.~\HL{rofa}{\B{rofa}}, beside, alongside.
...
\on{1}.~\HL{sAro'a}{\B{säro'a}}, feat, accomplishment, great deed. \\  
\on{2}.~\HL{txanro'a}{\B{txanro'a}}, be famous.
...
\on{1}.~\HL{rolyu}{\B{rolyu}}, singer. \\
\on{2}.~\HL{tIrol}{\B{tìrol}}, song. \\
\on{3}.~\HL{ronguway}{\B{ronguway}}, howl.
...
\on{1}.~\HL{ronsrel}{\B{ronsrel}}, s.t. imagined. \\  
\on{2}.~\HL{fpomron}{\B{fpomron}}, (mental) health. \\
\on{3}.~\HL{sIlronsem}{\B{sìlronsem}}, clever, smart (of things).
...
\on{2}.~\HL{tIronsrel}{\B{tìronsrel}}, imagination. \\
\on{3}.~\HL{leronsrel}{\B{leronsrel}}, imaginary. \\ 
\on{4}.~\HL{nIronsrel}{\B{nìronsrel}}, in\slash by imagination.
...
\B{Oel ron\-srel\-ngop fu\-ta Ey\-we\-veng\-it tok.} I imagine that I'm on Pandora.
\B{Tsat ke tsun oe ron\-srel\-ngi\-vop.} I can't imagine that.~\emph{both}~\LINK{http://naviteri.org/2011/02/new-vocabulary-part-2/}{b}
...
\on{1}.~\HL{ronguwayyu}{\B{ronguwayyu}}, howler.
...
\on{1}.~\HL{tsongropx}{\B{tsongropx}}, hole, cavity.
...
\B{Sra\-ne, fì\-txon tsun nga ni\-väk swo\-at nì\-'it, slä rä\-'ä rou!} Yes, you can have a little alcohol tonight, but don't get drunk!
\B{Nga tsun ni\-väk wew\-a pay\-it. Ul\-te ke ra\-you!} You can drink cold water. And not get drung!~\emph{both}~\LINK{http://naviteri.org/2012/10/audio-and-video-learning-materials-for-navi-101/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{rumut}{\B{rumut}}, puffball tree. 
...
\on{1}.~\HL{vArumut}{\B{värumut}}, vein pod.
...
(\ding{214}~\B{fwew}) \\  
\on{1}.\HL{ultxarun}{\B{ultxarun}}, encounter, meet by chance. \\
\on{2}.~\HL{lepxìmrun}{\B{lepxìmrun}}, common, often found.

% rurur
\hi
\HT{rurur}{\B{ru\cp{rur}}} \I{[Ru."RuR]} \emph{or} \I{[."RUR]} \emph{uncountable n.} kind of waterfall, \emph{water that is aerated while flowing among the rocks of a very gradually sloping stream}.
...
% rutxe
\hi
\HT{rutxe}{\B{ru\cp{txe}}} \I{[Ru."t'E]} (idiom) please.
