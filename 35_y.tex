...
% -ya
\hi 
\HT{-ya}{\B{-ya}} \I{[.ja]} \emph{suf. vocative for collective nouns}.
...
(\ding{43}~\HL{ya}{\B{ya}}, \HL{pay2}{\B{pay}}) \\  
\textsc{Derivatives}: \ding{43}
...
(\ding{43}~\HL{yem}{\B{yem}}, \HL{nemfa}{\B{nem\-fa}} \HL{pay2}{\B{pay}})
...
% yomyo lerìk
\hi 
\HT{yomyo lerIk}{\B{\cp{yom}yo le\cp{rìk}}} \I{["jom.jo{} lE."rIk\textcorner]} \emph{n.} leaf plate; (\emph{coll.}: \HL{rIk}{\B{rìk}})
