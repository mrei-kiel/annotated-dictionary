...
\textsc{Derivations}: \on{1}.~\HL{yafkeyk}{\B{ya\-fkeyk}}, weather.  
...
\B{Hay\-a yak\-ro fti\-vang. Sa\-lew rä\-'ä.} Stop at the next fork. Do not proceed further. \\
\textsc{ii}. \B{yak si} \I{[jak\textcorner si]} \emph{vin.} diverge, change direction, go astray.
\B{Ne 'o\-ra\-tsyìp po\-lä\-hem, yak si nì\-ftär.} When you arrive at the pond, turn to the left.
\B{Aw\-nga ze\-ne vi\-var ìlä fì\-sa\-lew\-fya. Zen\-ke yak si\-vi.} We must continue in this direction. We must not go astray.~\emph{all}~\LINK{http://naviteri.org/2013/09/on-si-salewfya-shapes-and-directions/}{b}

% yaney
\hi 
\HT{yaney}{\B{ya\cp{ney}}} \I{[ja."nEj]} \emph{n.} canoe. \\
\on{1}.~\HL{spulyaney}{\B{spulyaney}}, canoe paddle.
...
\B{Po yaw\-ne lu por.} He\slash she loves him\slash her.
\B{Po yaw\-ne lu snor.} He loves himself.
\B{Me\-fo yaw\-ne lu (snor) fì\-tsap.} They (= those two) love each other.\emph{all}~\LINK{http://naviteri.org/2011/12/one-more-for-2011/}{b} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{yawrwll}{\B{yawrwll}}, feather blade.

% yawrwll
\hi 
\HT{yawrwll}{\B{\cp{yawr}wll}} \I{["jawR.w\s{l}]} \emph{n.} \ding{96} feather blade [lit.: `feather plant']. 
(\ding{43}~\HL{yawr}{\B{yawr}}, \HL{'ewll}{\B{'ewll}}) 
...
(\emph{vulg.}) \B{Yayl!} `Bullshit!'  \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{leyayl}{\B{leyayl}}, nonsensical.

% yawo
\hi 
\HT{yawo}{\B{ya\cp{wo}}} \I{[ja."w$\cdot$o]} \emph{vin., inf.}\on{22} take off, launch.   
\B{Fwa ya\-wo ftu kll\-te to fwa tsway\-on ftu 'awkx lu ngä\-zìk.} Taking off from the ground is harder than flying off a cliff.
\B{'Uol ik\-ran\-it txo\-pu sley\-ko\-la\-tsu, ta\-lun\-a po tsìk ya\-wo.} Something must have frightened the banshee, because it suddenly took to the air.~\emph{both}~\LINK{http://naviteri.org/2012/01/mipa-zisit-ayliu-amip-new-words-for-the-new-year/}{b}
...
\B{Ki\-fkey\-ri fì\-tu\-tan\-ìl a\-yay\-mak ke tslam stum ke\-'ut.} This foolish man understands almost nothing.~\LINK{http://naviteri.org/2016/12/tengkrr-perahem-zisit-amip-as-the-new-year-arrives/}{b}

% yayo 
\hi 
\HT{yayo}{\B{\cp{ya}yo}} \I{["ja.jo]} \emph{n.} bird. 
...
\on{1}.~\HL{yayotsrul}{\B{yayotsrul}}, bird's nest.
...
\B{Sra\-ke fo hang\-ham ta\-lu\-na nga snaytx? Fo\-ti yäkx.} They're laughing because you lost? Ignore them.
\B{Tsam\-si\-yu ze\-ne tsi\-vun yi\-väkx sne\-yä tì\-sraw\-it.} Warriors must be able to ignore their own pain.~\emph{both}~\LINK{http://naviteri.org/2015/03/kap-si-ayunil-saylahe-threats-dreams-and-other-things/}{b}
(\ding{214}~\HL{tseri}{\B{tse\-ri}}) \\
\on{1}.~\HL{tIyAkx}{\B{tìyäkx}}, lack of notice; snubbing. \\
\on{2}.~\HL{sAyAkx}{\B{säyäkx}}, snub.
...
\B{Tsa\-ri\-a fkol po\-le\-'un fu\-ta Lo\-ak slu ta\-ron\-yu, sem\-pul 'efu ye.} Father is content that it's been decided Loak will be a hunter.
\B{Nge\-yä tì\-kang\-kem\-ìri 'e\-fe\-iu oe ye nì\-txan. Sey\-so\-nìl\-tsan!} I'm very satisfied with your work. Well done!
\B{Sra\-ke ye\-hakx? -- Ye. Tsun ti\-vam.} Did you get enough to eat? -- Yes. That'll be enough.~\emph{all}~\LINK{http://naviteri.org/2011/04/\%E2\%80\%99a\%E2\%80\%99awa-li\%E2\%80\%99fyavi-amip\%E2\%80\%94a-few-new-expressions/}{b} \\
...
\B{Kar\-yul fngo\-lo' fu\-ta ay\-nu\-me\-yu pi\-va\-te ye'\-krr.} The teacher required the students to arrive early.~\emph{all}~\LINK{http://naviteri.org/2012/01/mipa-zisit-ayliu-amip-new-words-for-the-new-year/}{b} \\
...
(\ding{43}~\HL{ya}{\B{ya}}, \HL{ohakx}{\B{o\-hakx}})
...
\B{Pen\-it yem\-stokx!} Get dressed!
\B{Su\-nu oer haw\-re' a ngal yo\-lem\-stokx.} I like the hat you're wearing.
\B{Fì\-re\-won ngal lum\-pe kea haw\-re'\-it ke yo\-lem\-stokx?} Why didn't you put on a hat this morning?~\emph{all}~\LINK{http://naviteri.org/2011/08/new-vocabulary-clothing/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIyewn}{\B{tì\-yewn}}, expression (\emph{of a thought or feeling}).
...
% Yeysu
% \hi
% \B{\cp{Yey}su} \I{["jEj.su]} \emph{n.}, \textsc{lw} Jesus.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{snayI}{\B{snayì}}, staircase, series of step\hyp{}like levels. 
...
\textsc{Derivations}: \on{1}.~\HL{sAyIm}{\B{sä\-yìm}}, tie, s.t. used for binding.

% yìspul
\hi 
\HT{yIspul}{\B{\cp{yì}spul}} \I{["jI.spul]} \emph{or} \I{[.spUl]} \emph{n.} \ding{96} mermaid tail. 
(\ding{43}~\HL{yI}{\B{yì}}, \HL{spule}{\B{spule}})
...
\textsc{Derivations}: \on{1}.~\HL{txayo}{\B{txa\-yo}}, field, plain. 
...
\B{Tì\-hawl le\-sngä\-'i lu tì\-kang\-kem\-vi skxawng\-ä, slä pum alu fì\-'u yo' nì\-'aw.} The original plan was the work of an idiot, but this one is just perfect.
\B{Fì\-stxel\-it fol txe\-ru\-la fpi olo'\-eyk\-tan. Ze\-ne yi\-vo' lu\-ke kxey\-ey\-o kaw\-'it.} They're constructing this gift for the chief. It must be perfect without a single flaw.
\B{Ri\-ni\-ri nik\-re yä\-ngo' nì\-tut.} Rini's hair is always perfect.
(\emph{b. conv. idiom}) \B{Ye\-io'}, perfect. 
\B{Ul\-txa si\-vi oeng sìn ram\-tsyìp txon\-'ong\-ay. -- Ye\-io'! Tsa\-krr\-vay ko!} Let's meet on the hill tomorrow at nightfall. -- Perfect! See you then.~\emph{all}~\LINK{http://naviteri.org/2012/01/mipa-zisit-ayliu-amip-new-words-for-the-new-year/}{b} \\
...
\B{Oel to\-lìng nga\-ru tsngan\-it yoa fkxen.} I traded you meat for vegetables.
\B{Fol ko\-la\-nom po\-ta ay\-srok\-it fay\-o\-ang\-yoa.} They bartered fish with him for beads.
\B{Ta\-yel Tse\-nul pxe\-swi\-zaw\-ti yoa mun\-sna\-hawn\-ven.} Tsenu will receive three arrows in exchange for a pair of shoes.
\B{Kä\-sro\-lìn oel nik\-ro\-it Pey\-ral\-ur yoa fwa po rol oer.} I loaned Peyral a hair ornament in exchange for her singing to me.
\B{Fu\-ta nga\-ta tel pxen\-yoa srät, mll\-'e\-i\-an oel.} I'm happy to take cloth from you for finished garments.
\B{Poel haw\-re'\-tsyìp\-it ko\-la\-nom yoa txo\-lar a\-me\-vol.} She bought a little cap for \$\on{16}.
\B{Kì\-ma\-nom oel mip\-a el\-tut le\-fngap yoa ew\-ro.} I just bought a new computer (for an unspecified amount of euros).~\emph{all}~\LINK{http://naviteri.org/2014/02/barter-and-exchange/}{b}
...
\B{Ma sem\-pu, oey yom\-yo tso\-lawng!} Daddy, my plate broke!
\B{Ma En\-tu, ngal lum\-pe ngey tsmu\-ke\-yä yom\-yot tsey\-ko\-lawng?} En\-tu, why did you break your sister's plate? \emph{both}~\LINK{http://naviteri.org/2020/04/aawa-u-amip-a-few-new-things/}{b}
(\ding{43}~\HL{yom}{\B{yom}}, \HL{yo}{\B{yo}}) \\
\on{1}.~\HL{yomyolerIk}{\B{yomyo lerìk}}, leaf plate.
...
% yrr
\hi 
\HT{yrr}{\B{yrr}} \I{[j\s{r}]} \emph{adj.} wild, natural (\emph{s.t. in its original, unmodified, untampered\hyp{}with natural state})
\B{Ik\-ran\-ìri krr\-a hu tu\-te tsa\-heyl si, ftang li\-vu yrr.} When an \emph{ikran} bonds with a person, it ceases to be wild.
\B{Lu tsa\-fne\-pay\-oang ftxì\-lor fra\-to krr\-a lu yrr.} That kind of fish is most tasty when eaten as \emph{sashimi}.
\B{Txep\-ìri, yrr\-a rìn\-ti rä\-'ä sar, ma skxawng.} Don't use that green wood for a fire, you fool.~\emph{all}~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}{b}
...
\B{Oe yä\-pur.} I wash myself.
\B{Oe yä\-pe\-rur.} I'm washing myself.~\emph{both}~\LINK{http://forum.learnnavi.org/language-updates/the-reflexive-\%28from-a-frommer-email!!!!\%29/}{ln} 
\\
\end{multicols}