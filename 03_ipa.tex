\pdfbookmark[1]{A Note on Pronunciation}{IPA}

\subsection*{A Note on Pronunciation}
...
This dialect is spoken by the Reef Clans like the Metkayina. It differs from Forest Na'vi as follows:
