...
\B{Ul\-te txo smi\-von ngar ay\-ho\-ak\-tu, ftxey soaia\-mì ftxey sko ey\-lan, fo\-ti pa\-lang fte tsi\-vun ivo\-mum teyng\-ta ftxey lu fo\-ru fpom fu\-ke.} And if you know elders, whether in the family or as friends, contact them to know whether they are alright or not.
(\emph{a. expression}) \B{Pa\-lang ko!} Keep in touch! \emph{both}~\LINK{http://naviteri.org/2020/03/teri-tifkeytok-lefkrr-about-the-present-situation/}{b} \\
...
\B{Pam\-rel\-fya\-ri fya\-pe?} How do you spell it?
\B{Lì\-'u\-ri alu tskxe pam\-rel fya\-pe?--Pam\-rel\-fya lu na Tsä, KxeKx, E.} How do you spell the word \emph{tskxe}?--It's spelled ts, kx, e.~\emph{both}~\LINK{http://naviteri.org/2010/08/a-na\%E2\%80\%99vi-alphabet/}{b} 
...
\B{Po pam\-tseo si fa au nìl\-tsan nì\-txan.} She plays the drums very well.~{\color{blue}\href{http://naviteri.org/2011/01/new-year-new-vocabulary/}{\textsc{b}}} 
(\ding{43}~\HL{pam}{\B{pam}}, \HL{tseo}{\B{tseo}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{pamtseotu}{\B{pamtseotu}}, musician. 
...
% parul
\hi 
\HT{parul}{\B{pa\cp{rul}}} \I{[pa."Rul]} \emph{or} \I{[."RUl]} \emph{n.} miracle. 
...
% parulnga'
\hi 
\HT{parulnga'}{\B{pa\cp{rul}nga'}} \I{[pa."Rul.NaP]} \emph{or} \I{[."RUl.]} \emph{adj.} miraculous. 
(\ding{43}~\HL{parul}{\B{pa\-rul}})

% parultsyìp
\hi 
\HT{parultsyIp}{\B{pa\cp{rul}tsyìp}} \I{[pa."Rul.\t{ts}jIp\textcorner]} \emph{or} \I{[."RUl.]} \emph{n. term of affection for children} (lit. `little wonder'). 
...
% pasuk
\hi 
\HT{pasuk}{\B{\cp{pa}suk}} \I{["pa.suk\textcorner]} \emph{or} \I{[.sUk\textcorner]} \emph{n.}, \ding{96} berry. 
...
% payoang
\hi
\HT{payoang}{\B{pay\cp{o}ang}} \I{[paj."{}o.aN]} \emph{countable n.} fish. 
...
% paysmung
\hi
\HT{paysmung}{\B{\cp{pay}smung}} \I{["paj.smuN]} \emph{or} \I{[.smUN]} \emph{n.} water carrier. 
...
\on{1}.~\HL{tIpAhem}{\B{tìpähem}}, arrival. \\  
\on{2}.~\HL{kllpA}{\B{kllpä}}, land, reach the ground.

% pänu
\hi
\HT{pAnu}{\B{\cp{pä}nu}} \I{["p\ae.nu]} \emph{n.} promise. \\  
\on{1}.~\HL{pAnutIng}{\B{pänutìng}}, promise.
...
\on{1}.~\HL{tIpAngkxo}{\B{tìpängkxo}}, chat, conversation. \\  
\on{2}.~\HL{pAngkxoyu}{\B{pängkxoyu}}, chatter, converser. \\
\on{3}.~\HL{tireapAngkxo}{\B{tireapängkxo}}, commune.
...
\on{1}. \B{pay}\texttt{+}, which (of them)? (plural). \\
\on{2}. \B{pem}\texttt{+}, what two? \\
\on{3}. \B{pep}\texttt{+}, what three? \\
\on{4}. \B{pefne}\texttt{-}, what kind?
...
\textsc{Derivations}: \on{1}.~\HL{tIpe'ngay}{\B{tì\-pe'\-ngay}}, conclusion.
...
% pe'un
\hi
\HT{pe'un}{\B{\cp{pe}'un}} \I{["pE.Pun]} \emph{or} \I{[.PUn]} \emph{vtr.} decide.  
...
% pekxinum 
\hi
\HT{pekxinum}{\B{pe\cp{kxi}num}} \I{[pE."k'i.num]} \emph{or} \I{[.nUm]} \emph{inter.} how tight\slash loose? (\emph{alternate form:} \ding{43}~\HL{'ekxinum}{\B{'e\-kxin\-um\-pe}})
...
(\ding{43}~\HL{la'a}{\B{la'a}}, \HL{pe}{\B{pe+}}; \HL{pelImsim}{\B{pelìmsim\slash lìmsimpe}})
...
% pengimpum
\hi 
\HT{pengimpup}{\B{pe\cp{ngim}pup}} \I{[pE."Nim.pup\textcorner]} \emph{or} \I{[.pUp\textcorner]} \emph{inter.} what length? how long (of physical extension)? (\emph{alternate form:} \ding{43}~\HL{ngimpup}{\B{ngim\-pup\-pe}}) 
...
(\ding{43}~\HL{}{\B{pe}}\texttt{+}, \HL{pxe}{\B{pxe}}\texttt{+})
...
(\ding{43}~\HL{pep}{\B{pep}}\texttt{+}, \HL{tutan}{\B{tutan}}) 	
...
(\ding{43}~\HL{pep}{\B{pep}}\texttt{+}, \HL{tute2}{\B{tuté}}) 
...
% pesrrpxì
\hi 
\B{pesrr\cp{pxì}} \I{[pE.s\s{r}."p'I]} \emph{inter.} what part of the day? what hour? (\emph{alternate form:} \ding{43}~\HL{trrpxI}{\B{trrpxìpe}}) 
...
\B{Sìl\-pey oe, aw\-nge\-yä lì'\-fya\-olo'\-ìri fì\-pì\-lok lì\-ye\-vu pxan.} I hope, this blog will be worth for our language community.
\B{Zo\-la\-'u nì\-prr\-te' ne pì\-lok Na'\-vi\-te\-ri.} Welcome to the \emph{Na'\-vi\-te\-ri blog}.
\B{Lu pì\-lok\-ur pxe\-sì\-kan sì pxe\-fne\-'upxa\-re.} The blog has three aims and three kinds of messages.
\B{Pì\-lok\-ä fì\-ha\-pxì\-yä tì\-kan lu law.} The aim of this part of the blog is clear.~\emph{all}~\LINK{http://naviteri.org/2010/06/first-post/}{b}
...
\B{Po lu pì\-saw. Trr\-am tol\-tem ve\-nu\-ti sne\-yä nìt\-kan\-lu\-ke.} He is accident\hyp{}prone. Yesterday he unintentionally shot his own foot
\B{Lu Saw\-tu\-te wok sì pì\-saw nì\-wotx, na prr\-nen.} The skypeople are all loud and clumsy, like a baby.~\emph{both}~\LINK{http://naviteri.org/2017/09/zisikrr-amip-ayliu-amip-new-words-for-the-new-season/}{b} 
...
(\ding{43}~\HL{tsupx}{\B{tsupx}}; \ding{214}~\HL{fkxake}{\B{fkxa\-ke}})
...
(\emph{a. with direct speech}) \B{Po ke tsun pi\-vll\-ngay san oe\-ru tì\-kxey.} He can't admit he's wrong.
\B{Oe pll\-ngay san mo\-lak\-to oe nì\-fe', ta\-fral sno\-laytx; wä\-tu lu oe\-to txur.} I acknowledge that I rode badly, so I lost; my opponent was stronger than I was.
(\emph{b. with the topic}) \B{Tsa\-'u\-ri po pll\-ngay.} He admits it.~\emph{all}~\LINK{http://naviteri.org/2011/07/txantsana-ultxa-mi-siatll-great-meeting-in-seattle/}{b}
...
(\ding{43}~\HL{po}{\B{po}})  \\
\textsc{Derivations}:
\on{1}.~\HL{pohan}{\B{po\-han}}, he (deferential form).
...
(\ding{43}~\HL{po}{\B{po}}) \\
\textsc{Derivations}:
\on{1}.~\HL{pohe}{\B{po\-he}}, she (deferential form).

% pohan
\hi 
\HT{pohan}{\B{po\cp{han}}} \I{[]} \emph{pn.} he (3\textsuperscript{rd} person singular; deferential\slash ceremonial form). 
...
(\ding{43}~\HL{po}{\B{po}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{pohe}{\B{pohe}}, she (deferential form).
\on{2}.~\HL{pohan}{\B{pohan}}, he (deferential form).
...
\B{Fwa pon sey\-ti sìn ki\-nam\-til lu le\-hrr\-ap, ma 'itan. Tsun ne\-kll zi\-vup tsawng.} Balancing a cup on your knee is dangerous, son. It can fall to the ground and break.
\B{Nì\-sngä\-'i Tsyeyk lu pì\-saw ul\-te ke tsun vul\-sìn pä\-pi\-von.} At first Jake was clumsy and wasn't able to balance on a branch. \emph{both}~\LINK{http://naviteri.org/2020/04/aawa-u-amip-a-few-new-things/}{b} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{prrku}{\B{prrku}}, womb. 
...
% prrsmung
\hi
\HT{prrsmung}{\B{\cp{prr}smung}} \I{["{}sju.smuN]} \emph{or} \I{[.smUN]} \emph{n.} baby carrier. 
...
% puk
\hi
\HT{puk}{\B{puk}} \I{[puk\textcorner]} \emph{or} \I{[pUk\textcorner]} \emph{n.}, \textsc{lw} book. 
...
\on{1}.~\HL{puktsyIp}{\B{puktsyìp}}, booklet. \\  
\on{2}.~\HL{lI'upuk}{\B{lì'upuk}}, dictionary.

% puktsyìp
\hi
\HT{puktsyIp}{\B{\cp{puk}tsyìp}} \I{["puk\textcorner.\t{ts}jIp\textcorner]} \emph{or} \I{["pUk\textcorner.]} \emph{n.} booklet, pamphlet. 
...
\on{1}.~\HL{vospxIpuk}{\B{Vospxìpuk}}, June.

% pum
\hi
\HT{pum}{\B{pum}} \I{[pum]} \emph{or} \I{[pUm]} (\textsc{rn:} \B{pùm} \I{[pUm]}) 
\emph{n.} (\emph{not marked for number}) possession, thing possessed; (``dummy noun'' with possessive pronouns to form ``disjunctive possessives'')
...
(\emph{a. idiom}) \B{Pum nge\-yä.} (\emph{in response to thanks}) ``You're welcome,'' i.e. The thanks belong to you.~\LINK{http://naviteri.org/2010/07/diminutives-conversational-expressions/}{b}
(\emph{b. can be ommitted in coll. conversation})
...
% pup
\hi
\HT{pup}{\B{pup}} \I{[pup\textcorner]} \emph{or} \I{[pUp\textcorner]} \emph{adj.} short (\emph{physical length}). 
...
\on{1}.~\HL{trrpuve}{\B{trrpuve}}, Friday.
