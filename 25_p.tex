...
% pamrìrlì'u
\hi 
\HT{pamrIrlI'u}{\B{pam\cp{rìr}lì'u}} \I{[pam."RIR.lI.Pu]} \emph{n.} onomatopoetic word.  
...
(\ding{43}~\HL{pay2}{\B{pay}}, \HL{mauti}{\B{mauti}}) 
...
(\ding{43}~\HL{pay2}{\B{pay}}, \HL{syulang}{\B{syu\-lang}})
...
% pängkxoyu lekoren
\hi
\HT{pAngkxoyu lekoren}{\B{päng\cp{kxo}yu leko\cp{ren}}} \I{[p\ae{}N."k'o.ju lE.ko."REn]} \emph{n.} lawyer, rule chatter.
...
% pe+
\hi
\HT{pe+}{\B{pe}\texttt{+}} \I{[pE.]} \emph{inter. pref. on nouns to mean} what? which?
\B{Ä\-txä\-le su\-yi o\-he pi\-vawm, pe\-o\-lo' lu\-yu pum nge\-nge\-yä?} May I ask what tribe you belong to? (\emph{overly formal, stilted Na'vi})~\LINK{http://naviteri.org/2010/09/getting-to-know-you-part-2/}{b} 
...
% -pe
\hi
\HT{-pe}{\B{-pe}} \I{[.pE]} \emph{inter. suf. on nouns to mean} what? which?
...
% pemsu
\hi
\HT{pemsu}{\B{pem\cp{su}}} \I{[pEm."{}su]} \emph{inter.} who? what two people?~\LINK{http://naviteri.org/2011/07/number-in-na\%E2\%80\%99vi/}{b} (\emph{alternate form:} \ding{43}~\B{me\-su\-pe})
(\ding{43}~\HL{pem+}{\B{pem}}\texttt{+}, \HL{tute1}{\B{tu\-te}}) 
	
% pemstan
\hi
\HT{pemstan}{\B{pem\cp{stan}}} \I{[pEm."{}stan]} \emph{inter.} who? what two men?~\LINK{http://naviteri.org/2011/07/number-in-na\%E2\%80\%99vi/}{b} (\emph{alternate form:} \ding{43}~\B{me\-stam\-pe})
...
% pepsu
\hi
\HT{pepsu}{\B{pep\cp{su}}} \I{[pEp\textcorner."{}su]} \emph{inter.} who? what three people? \emph{alternate form:} \ding{43}~\B{pxe\-su\-pe}
...
% pepstan
\hi
\HT{pepstan}{\B{pep\cp{stan}}} \I{[pEp\textcorner."{}stan]} \emph{inter.} who? what three men? \emph{alternate form:} \ding{43}~\B{pxe\-stam\-pe}
(\ding{43}~\HL{pep+}{\B{pep}}\texttt{+}, \HL{tutan}{\B{tu\-tan}}) 	
	
% pepste
\hi
\HT{pepste}{\B{pep\cp{ste}}} \I{[pEp\textcorner."{}stE]} \emph{inter.} who? what three women? \emph{alternate form:} \ding{43}~\B{pxe\-ste\-pe}
(\ding{43}~\HL{pep+}{\B{pep}}\texttt{+}, \HL{tute2}{\B{tu\-té}}) 

% peseng
\hi
\HT{peseng}{\B{pe\cp{seng}}} \I{[pE."{}sEN]} \emph{or} \B{pe\cp{se}nge} \I{[pE."{}sE.NE]} \emph{inter.} where? what place? (\emph{alternative form:} \ding{43}~\B{tseng\-pe})
\B{Tok pe\-se\-nget pam\-rel\-ìl?} Where is the text?~\LINK{http://naviteri.org/2014/06/teri-tsaliu-alu-nifkeytongay-about-nifkeytongay/}{b}
...
% peslosnep
\hi
\HT{peslosnep}{\B{peslo\cp{snep}}} \I{[pE.slo."{}snEp\textcorner]} \emph{inter.} what width? how wide? (\emph{alternate form:} \ding{43}~\B{slo\-snep\-pe})
(\ding{43}~\HL{pe+}{\B{pe}}\texttt{+}, \HL{slosnep}{\B{slo\-snep}}) 

% pesomwew
\hi
\HT{pesomwew}{\B{pesom\cp{wew}}} \I{[pE.som."wEw]} \emph{inter.} what temperature? (\emph{alternate form:} \ding{43}~\B{som\-wew\-pe})
...
% peu 
\hi
\HT{peu}{\B{pe\cp{u}}} \I{[pE."{}u]} \emph{inter.} what (thing)? (\emph{alternate form:} \ding{43}~\HL{'u}{\B{'u\-pe}})
...
% pukap
\hi
\HT{pukap}{\B{\cp{pu}kap}} \I{["pu.kap\textcorner]} \emph{num.} six. (\emph{base}: \ding{43}~\HL{pu}{\B{pu-}}, \emph{rest}: \ding{43}~\HL{-fu}{\B{\mbox{-fu}}}) \\
\textsc{Derivatives}: \ding{43}
