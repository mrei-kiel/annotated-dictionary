...
% oe
\hi
\HT{oe}{\B{\cp{o}e}} \I{["{}o.E]} (\emph{with case endings, enclitic adp.s or before `u' coll. pronounced as:} \I{["wE-]}) \emph{pn.} I (1\textsuperscript{st} person singular). 
(\emph{a. subjective}) 
...
(\emph{d. genitive}) \B{\cp{oe}yä} \I{["wE.j\ae]} \emph{or coll.} \B{oey} \I{[wEj]}
...
\on{1}.~\HL{ohe}{\B{ohe}}, I (deferential).
\on{2}.~\HL{moe}{\B{moe}}, us two (exclusive).
\on{3}.~\HL{oeng}{\B{oeng}}, us two (inclusive).
\on{4}.~\HL{pxoe}{\B{pxoe}}, us three (exclusive).
\on{5}.~\HL{ayoe}{\B{ayoe}}, we (exclusive).

% oeng
\hi
\HT{oeng}{\B{o\cp{eng}}} \I{[o."{}EN]} (\emph{with case endings or enclitic adp.s always pronounced as:} \I{[wE."N-]}) \emph{pn.} we (two), you and I, the two of us (1\textsuperscript{st} person dual inclusive).
(\emph{a. subjective}) 
...
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{pxoeng}{\B{pxo\-eng}}, us three (inclusive).
\on{3}.~\HL{ayoeng}{\B{ay\-oeng}}, we (inclusive).
...
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{oeyktIng}{\B{oeyk\-tìng}}, explain (why).
...
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{tIoeyktIng}{\B{tì\-oey\-ktìng}}, explanation.
...
(\ding{214}~\HL{vAng}{\B{väng}}; \ding{214}~\HL{yehakx}{\B{ye\-hakx}}) \\
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{tIohakx}{\B{tì\-o\-hakx}}, hunger.
\on{2}.~\HL{yehakx}{\B{ye\-hakx}}, satisfied from hunger, full.
...
% oheng
\hi
\HT{oheng}{\B{\cp{o}heng}} \I{["{}o.hEN]} \emph{pn.} we (two), you and I, the two of us (1\textsuperscript{st} person dual inclusive; deferential\slash ceremonial).
(\emph{genitive}) \B{'Aw\-vea ul\-txa\-ri ohe\-nge\-yä, Naw\-ma Sa'\-nok lrr\-tok si\-vei\-yi.} May the Great Mother smile upon our first meeting.~\LINK{https://wiki.learnnavi.org/Na\%27vi_from_Avatar_Movie\#Grace_and_Norm_in_the_Link_room}{a\slash wiki}
(\ding{43}~\HL{oeng}{\B{oeng}}, \HL{ayoheng}{\B{ayo\-heng}})
...
% okup
\hi
\HT{okup}{\B{\cp{o}kup}} \I{["{}o.kup\textcorner]} \emph{or} \I{[.kUp\textcorner]} (\textsc{rn}: \B{\cp{o}kùp} \I{["{}o.kUp\textcorner]}) \emph{n.} milk.
...
\textsc{Derivatives}: \ding{43}
\on{1}.~\HL{okupsyu}{\B{o\-kup\-syu}}, dairy product.

% okupsyu
\hi 
\HT{okupsyu}{\B{\cp{o}kupsyu}} \I{["{}o.kup\textcorner.sju]} \emph{or} \I{[.kUp\textcorner.]} (\textsc{rn}: \B{\cp{o}kùpsyu} \I{["{}o.kUp\textcorner.Su]}) \emph{n.} dairy product. 
(\ding{43}~\HL{okup}{\B{o\-kup}}, \HL{syuve}{\B{syu\-ve}})

% ‹ol›
\hi
‹\HT{ol}{\B{ol}}› \I{[o.l]} \emph{inf. in} ‹1› \emph{to form the perfective aspect}.
...
\on{6}.~\HL{olo'tu}{\B{o\-lo'\-tu}}, clan member.
...
(\ding{43}~\HL{olo'}{\B{olo'}}, \HL{eyktan}{\B{eyk\-tan}}; \HL{olo'eykte}{\B{olo'\-eyk\-te}})
...
(\ding{43}~\HL{olo'eyktan}{\B{olo'\-eyk\-tan}})

% olo'tu
\hi
\HT{olo'tu}{\B{o\cp{lo'}tu}} \I{[o."loP.tu]} \emph{n.} clan member.~\LINK{https://forum.learnnavi.org/language-updates/a-collection-of-questions-answered/msg679687/\#msg679687}{ln}
(\ding{43}~\HL{olo'}{\B{olo'}}, \HL{-tu}{\B{-tu}}) \\
\textsc{Derivatives}: \ding{43}
...
% omum
\hi
\HT{omum}{\B{o\cp{mum}}} \I{[o."mum]} \emph{or} \I{[."mUm]} (\textsc{rn}: \B{o\cp{mùm}} \I{[o."mUm]}) \emph{vtr.} know (a fact). (\emph{in any inflected or derived form, the stress shifts to the o, e.g.}~\B{i\cp{vo}mum} \I{[i."vo.mum]})    
...
\textsc{Derivatives}: \ding{43} 
\on{1}.~\HL{tIomum}{\B{tì\-o\-mum}}, knowledge. 
...
\textsc{Derivatives}: \ding{43}  
\on{1}.~\HL{onlor}{\B{on\-lor}}, good-smelling. 
\on{2}.~\HL{onvA'}{\B{on\-vä'}}, bad-smelling. 
\on{3}.~\HL{ontsang}{\B{on\-tsang}}, nose ring. 
\on{4}.~\HL{tIng}{\B{tìng on\-tu}}, (to) smell.
