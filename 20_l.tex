...
% lätek
\hi 
\HT{lAtek}{\B{\cp{lä}tek}} \I{["l\ae.tEk\textcorner]} \emph{vtr.} recognize (\emph{a person\slash the significance of s.t.}). 
...
% le'awnì'aw
\hi 
\HT{le'awnI'aw}{\B{le\cp{'aw}nì'aw}} \I{[lE."Paw.nI.Paw]} \emph{adj.} unique (\emph{i.e., exclusivity}). 
...
% lekye'ung
\hi
\HT{lekye'ung}{\B{lek\cp{ye}'ung}} \I{[lEk\textcorner."jE.PuN]} \emph{or} \I{[.PUN]} (\textsc{rn}: \B{lek\cp{ye}ùng} \I{[lEk\textcorner."jE.UN]}) \emph{adj.} insane, crazy. 
...
% lekxu
\hi 
\HT{lekxu}{\B{le\cp{kxu}}} \I{[lE."k'u]} \emph{adj.} harmful. 
...
% lemungwrr
\hi 
\HT{lemungwrr}{\B{lemung\cp{wrr}}} \I{[lE.muN."w\s{r}]} \emph{or} \I{[.mUN.]} (\textsc{rn}: \B{lemùng\cp{wrr}} \I{[lE.mUN."w\s{r}]}) \emph{adj.} exceptional. 
...
(\ding{43}~\HL{pay2}{\B{pay}}, \HL{paynga'}{\B{pay\-nga'}})
...
% lereymtxew
\hi 
\HT{lereymtxew}{\B{le\cp{reym}txew}} \I{[lE."REjm.t'Ew]} \emph{adj.} coastal. 
...
% lì'fyaolo'tu
\hi
\HT{lI'fyaolo'tu}{\B{\cp{lì'}fyaolo'tu}} \I{["lIP.fja.o.loP.tu]}  \emph{n.} member of the language group\slash \emph{Sprachbund}.~\LINK{https://forum.learnnavi.org/language-updates/a-collection-of-questions-answered/msg679687/\#msg679687}{ln}
...
% lì'upuk
\hi
\HT{lI'upuk}{\B{\cp{lì}'upuk}} \I{["lI.Pu.puk\textcorner]} \emph{or} \I{[.pUk\textcorner]} (\textsc{rn}: \B{\cp{lì}upùk} \I{["lI.u.pUk\textcorner]})  \emph{n.} dictionary.
...
% luan
\hi 
\HT{luan}{\B{\cp{lu}an}} \I{["lu.an]} \emph{vtr.} owe (\emph{moral obligation to give s.t. to s.o.}). 
