...
% -l
\hi
\HT{l}{\B{-l}} \I{[l]} \emph{suf. to mark the agentive case of a n. ending in a vowl or diphthong}. 
(\ding{43}~\HL{Il}{\B{-ìl}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{pela'a}{\B{pe\-la\-'a}}, how near, how far, what distance.
...
% la'um
\hi 
\HT{la'um}{\B{\cp{la}'um}} \I{["la.Pum]} \emph{or} \I{[.PUm]} \emph{vin.} pretend (\emph{used with} \ding{43}~\HL{tsnI}{\B{tsnì}}). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIla'um}{\B{tì\-la\-'um}}, pretence.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lapo}{\B{la\-po}}, another (one). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tslikxyutsawlak}{\B{tslikxyu tsawlak}}, scarab crawler.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{txanlal}{\B{txan\-lal}}, ancient, very old.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlam}{\B{tì\-lam}}, appearance.   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lanutral}{\B{la\-nut\-ral}}, dandetiger.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlang}{\B{tì\-lang}}, exploration. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlapx}{\B{tì\-lapx}}, regret. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlatem}{\B{tì\-la\-tem}}, change (abstract concept). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIlaw}{\B{nì\-law}}, clearly.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'onglawn}{\B{'ong\-lawn}}, \emph{exhiliration of first bonding}.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlayl}{\B{tì\-layl}}, innocence. 
\on{2}.~\HL{nIlayl}{\B{nì\-layl}}, innocently. 

% layompin
\hi
\HT{layompin}{\B{la\cp{yom}pin}} \I{[la."jom.pin]}  \emph{n.} the color black. 
(\ding{43}~\HL{layon}{\B{la\-yon}}, \HL{'opin}{\B{'opin}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{layompin}{\B{la\-yom\-pin}}, (the color) black.

% layro
\hi 
\HT{layro}{\B{\cp{lay}ro}} \I{["laj.Ro]} \emph{adj.} free (\emph{from oppression}). \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlayro}{\B{tì\-lay\-ro}}, freedom. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sAlAtxayn}{\B{sä\-lä\-txayn}}, defeat.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lI'fyeng}{\B{lì'\-fyeng}}, honorific language. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lek}{\B{ley\-kek}}, enforce.
...
% lekye'ung
\hi
\HT{lekye'ung}{\B{lek\cp{ye}'ung}} \I{[lEk\textcorner."jE.PuN]} \emph{or} \I{[.PUN]} \emph{adj.} insane, crazy. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIlen}{\B{tì\-len}}, event. 
...
% lenomum
\hi
\HT{lenomum}{\B{le\cp{no}mum}} \I{[lE."no.mum]} \emph{or} \I{[.mUm]}  \emph{adj.} curious.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIler}{\B{nì\-ler}}, steadily.
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{yomyolerIk}{\B{yom\-yo le\-rìk}}, leaf plate.
...
(\ding{43}~\HL{trr}{\B{trr}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{keltrrtrr}{\B{kel\-trr\-trr}}, unusual.

% letut
\hi 
\HT{letut}{\B{le\cp{tut}}} \I{[lE.tut\textcorner]} \emph{or} \I{[.tUt\textcorner]} \emph{adj.} constant, continual. 
...
% letsunslu
\hi
\HT{letsunslu}{\B{le\cp{tsun}slu}} \I{[lE."\t{ts}un.slu]} \emph{or} \I{[."\t{ts}Un.]}  \emph{adj.} possible. 
...
\textsc{Derivations}: \on{1}.~\HL{ketsuklewn}{\B{ke\-tsuk\-lewn}}, intolerable, unacceptable, unbearable.
...
\textsc{Derivations}: \on{1}.~\HL{lelewng}{\B{le\-lewng}}, shameful. \\
...
% leykatem
\hi
\HT{leykatem}{\B{ley\cp{ka}tem}} \I{[lEj."k$\cdot$a.t$\cdot$Em]} \emph{vtr.}\on{23} change s.t.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{horenleykekyu}{\B{ho\-ren\-ley\-kek\-yu}}, law enforcer, police officer.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIleym}{\B{tì\-leym}}, call.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIleymkem}{\B{tì\-leym\-kem}}, protesting, protest. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIli}{\B{nì\-li}}, in advance. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'awlie}{\B{'aw\-lie}}, once (\emph{experiential}).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{krrlik}{\B{krr\-lik}}, point in time.

% limang
\hi
\HT{limang}{\B{li\cp{mang}}} \I{[li."maN]}  \emph{n.} moot, celebratory gathering or event. 
\B{A\-ha'\-ri wrr\-ko\-lä fte li\-mang si\-vu\-nu por.} Aha'ri is out enjoying the moot.~\LINK{}{fop}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nga'lini}{\B{nga'lini}}, be pregnant (for animals).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sAlipx}{\B{sä\-lipx}}, drip (of liquid).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lI'fyavi}{\B{lì'\-fya\-vi}}, expression.   
...
(\ding{43}~\HL{lI'fya}{\B{lì'\-fya}}, \HL{olo'}{\B{olo'}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{fyengkekin}{\B{fyeng\-ke\-kin}}, no need to use honorific language.
...
\B{Nge\-yä fay\-lì\-'u\-ri sei\-yi oe i\-ra\-yo.} I thank you for these words of yours.~\LINK{http://naviteri.org/2011/08/new-vocabulary-clothing/comment-page-1/\#comment-995}{b} \\ 
 \textsc{Derivations}: \on{1}.~\HL{lI'fya}{\B{lì'\-fya}}, language. 
...
(\ding{43}~\HL{lI'u}{\B{lì\-'u}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{eolI'uvi}{\B{eo\-lì\-'u\-vi}}, prefix. \\
...
\textsc{Derivations}: \on{1}.~\HL{lIngtskxe}{\B{lìng\-tskxe}}, unobtanium.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lo'akur}{\B{lo'akur}}, Toruk Makto Amulet.
...
% lo'akur
\hi 
\HT{lo'akur}{\B{lo'a\cp{kur}}} \I{[lo.Pa."kur]} \emph{or} \I{[."kUR]} \emph{n.} Toruk Makto Amulet.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIloho}{\B{tì\-lo\-ho}}, surprise. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lomtu}{\B{lom\-tu}}, missed person.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIklonu}{\B{nìk\-lo\-nu}}, firmly, steadfastly, faithfully. \\
...
(\ding{214}~\HL{vA'}{\B{vä'}}) \\  
\textsc{Derivations}: \on{1}.~\HL{tIlor}{\B{tì\-lor}}, beauty.   
...
% loreyu
\hi
\HT{loreyu}{\B{lo\cp{re}yu}} \I{[lo."RE.ju]}  \emph{adj.} helicoradian, ``beautiful spiral'', \emph{helicoradium spirale}. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{luke}{\B{lu\-ke}}, without. 
...
\B{Po maw kxitx mun\-txa\-tu\-ä 'a\-me\-fu na la\-nay'\-ka re'\-o\-lu\-ke.} After the death of his spouse, he felt completely lost.~\LINK{http://naviteri.org/2021/08/ulte-ayyoratu-leiu-and-the-winners-are-2/}{b} \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lukpen}{\B{luk\-pen}}, naked. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nIlun}{\B{nì\-lun}}, of course, logically.   
...
% lupra
\hi
\HT{lupra}{\B{\cp{lup}ra}} \I{["lup\textcorner.Ra]} \emph{or} \I{["lUp\textcorner.]} \emph{n.} style.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{fyolup}{\B{fyo\-lup}}, exquisite, sublime in taste. 
