...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{ikranay}{\B{ik\-ra\-nay}}, forest banshee.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{til}{\B{til}}, joint, hinge. \\  
...
% ‹ilv›
\hi
‹\B{ilv}› \I{[il.v]} \emph{inf. in} ‹1› \emph{to form the perfective subjunctive}.
...
% ‹imv›
\hi
‹\B{imv}› \I{[im.v]} \emph{inf. in} ‹1› \emph{to form the past subjunctive}.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tinan}{\B{ti\-nan}}, reading. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{ningyen}{\B{ning\-yen}}, mysteriously. 
...
(\ding{214}~\HL{Ao}{\B{äo}}) \\
\textsc{Derivations:} \ding{43} \on{1}.~\HL{ionar}{\B{io\-nar}}, banshee rider visor.
...
% ioang
\hi
\HT{ioang}{\B{i\cp{o}ang}} \I{[i."{}o.aN]} \emph{n.} animal, beast. 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{payoang}{\B{pay\-oang}}, fish.   
...
\textsc{iii}. \HT{ioi sApi}{\B{i\cp{o}i sä\cp{pi}}} \I{[i."{}o.i s\ae."pi]} (\B{sä\-pi} \emph{and its derivations is often shortened to} \I{[spi]}) \emph{vin.} adorn oneself (\HL{fa}{\B{fa}}, with), put on (adornment). 
...
(\ding{214}~\HL{'aku}{\B{'aku}}, \ding{43}~\HL{yemstokx}{\B{yem\-stokx}})

% irayo / irayo si
\hi
\HT{irayo}{\B{i\cp{ra}yo}} \I{[i."Ra.jo]} \textsc{i}.~\emph{n.} thank; (\emph{a. idiom}) `Thanks,' `Thank you.' 
...
% ‹irv›
\hi
‹\B{irv}› \I{[iR.v]} \emph{inf. in} ‹1› \emph{to form the imperfective subjunctive}.
...
% ‹iv›
\hi
‹\B{iv}› \I{[i.v]} \emph{inf. in} ‹1›. (\emph{a.}) \emph{to form the subjunctive}. 
