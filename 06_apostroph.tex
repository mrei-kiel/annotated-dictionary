...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'al}{\B{tì'al}}, wastefulness. 
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{'ampirikx}{\B{'ampirikx}}, leaf pitcher plant.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{syep'an}{\B{syep\-'an}}, lift vine.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sA'anla}{\B{sä'anla}}, yearning.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'aw\-ve}{\B{'awve}}, first.   
...
% 'awlo
\hi
\HT{'awlo}{\B{\cp{'aw}lo}} \I{["Paw.lo]} \emph{adv.} once, one time (\emph{marks a single instance of something}).  \B{Oel yo\-lom tey\-lut 'aw\-lo nì\-'aw.} I ate \emph{teylu} only once.~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}{b} (\ding{43}~\HL{'aw}{\B{'aw}}, \HL{alo}{\B{alo}})
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{tI'awm}{\B{tì'awm}}, camping.
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{'awstengyem}{\B{'awstengyem}}, join.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'Alek}{\B{tì\-'ä\-lek}}, determination. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kA'ArIp}{\B{kä'ärìp}}, push.  
\on{2}.~\HL{za'ArIp}{\B{za'ärìp}}, pull.
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{'e'insey}{\B{'e'insey}}, drinking gourd.
...
(\emph{b. vin.}) \emph{with predicate adj. for inner feelings}   \B{'efu nit\-ram, ke\-ftxo, som, wew, o\-hakx, väng, ye, ye\-hakx, ye\-väng, am\-'a\-ke, tu\-nu} be\slash feel happy, upset, hot, cold, hungry, thirsty, satisfied, full, quenched, confident\slash sure, romantic. 
\B{Me\-nga 'efu väng srak?} Are you two thirsty?~\LINK{http://naviteri.org/2011/01/new-year-new-vocabulary/}{b} 
\B{Ngey\-ä tì\-kang\-kem\-ì\-ri 'e\-fe\-i\-u oe ye nì\-txan.} I'm very satisfied with your work.~\LINK{http://naviteri.org/}{b} 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'efu}{\B{tì'efu}}, feeling.
\on{2}.~\HL{txukxefu}{\B{txu\-kxe\-fu}}, dare, be concerned about.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{lI'kong}{\B{lì'\-kong}}, syllable. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'emyu}{\B{'emyu}}, cook. 
...
\textsc{ii.} \B{'en si} \I{[PEn si]} \emph{vin.} make an informed guess.   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{le'en}{\B{le'en}}, speculative, intuitive.  
\on{2}.~\HL{nI'en}{\B{nì'en}}, making an informed guess.

% 'eng
\hi 
\HT{'eng}{\B{'eng}} \I{[PEN]} \emph{n., fauna} beak of a bird or animal. 

% 'engeng
\hi
\HT{'engeng}{\B{\cp{'eng}eng}} \I{["PEN.EN]} \emph{adj.} level. \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nI'eng}{\B{nì'eng}}, levelly, equally.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sA'eoio}{\B{sä'eoio}}, ritual, rite.   
\on{2}.~\HL{nI'eoio}{\B{nì'eoio}}, ceremoniously.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'evengan}{\B{'evengan}}, boy. 
\on{2}.~\HL{'evenge}{\B{'evenge}}, girl. 
\on{3}.~\HL{'evi}{\B{'evi}}, kid. 
...
% 'evenge
\hi
\HT{'evenge}{\B{\cp{'e}venge}} \I{["PE.vEN.E]} \emph{n.} (\emph{pl.} \B{me\-veng\-e}, \B{pxe\-veng\-e}, \B{ay\-e\-veng\-e\slash e\-veng\-e}) girl.%~\LINK{}{b}  
(\ding{43}~\HL{'eveng}{\B{'e\-veng}}, \HL{'eve}{\B{'e\-ve}})  

% 'evi
\hi
\HT{'evi}{\B{\cp{'e}vi}} \I{["PE.vi]} \emph{n.} (\emph{pl.} \B{me\-vi}, \B{pxe\-vi}, \B{ay\-e\-vi\slash e\-vi}) kid (\emph{affectionate form of `child'}). \B{Slä ay\-e\-vi nì\-wotx tso\-lun tsli\-vam (pot).} But all children could understand (her).~\LINK{http://naviteri.org/2010/07/ting-mikyun-fte-tslivam-listening-comprehension-1-3/}{b} 
(\ding{43}~\HL{'eveng}{\B{'e\-veng}})

% 'ewan
\hi
\HT{'ewan}{\B{\cp{'e}wan}} \I{["PE.wan]} \emph{adj.} young.   \B{ay\-lì'\-u\-fa aw\-ngey\-ä 'ey\-lan\-ä a\-'e\-wan}, in the words of our young friend.~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln} \B{Ay\-hem\-ì\-ri 'e\-wan\-a tsa\-nan\-tang\-ur a\-hì\-'i tìng na\-ri.} Look at what that little young viperwolf is doing.~\LINK{http://naviteri.org/2012/01/more-additions-to-the-lexicon/}{b} 
(\ding{214}~\HL{koak}{\B{ko\-ak}}) \\
\on{4}.~\HL{kewan}{\B{kewan}}, age.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{prrwll}{\B{prr\-wll}}, moss. 
...
% 'ewrang
\hi
\HT{'ewrang}{\B{\cp{'ew}rang}} \I{["PEw.RaN]} \emph{n., text.} (\emph{pl} \B{mewrang}, \B{pxewrang}, \B{ayewrang\slash ewrang}) loom. \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sa'ewrang}{\B{sa'ewrang}}, great loom, mother loom.

% 'eylan
\hi
\HT{'eylan}{\B{\cp{'ey}lan}} \I{["PEj.lan]} \emph{n.} (\emph{pl.} \B{mey\-lan}, \B{pxey\-lan}, \B{ay\-ey\-lan\slash ey\-lan}) friend.  \B{ay\-ey\-lan\-ur oe\-yä sì ey\-lan\-ur lì'\-fya\-yä le\-Na'\-vi nìwotx}, to my friends and all friends of the Na'vi language.~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln} \B{Menga lu oeyä 'eylan.} You two are my friends.~\LINK{http://naviteri.org/2011/07/number-in-na\%E2\%80\%99vi/}{b} \B{aw\-nge\-yä 'ey\-lan\-hu mll\-te (oe)}, (I) agree with our friend.~\LINK{http://masempul.org/2010/07/\%E2\%80\%99ite-polaheiem/}{sempul} \B{Srake smon ngar oeyä meylan alu Entu sì Kamun?} Do you know my friends Entu and Kamun?~\LINK{http://naviteri.org/2010/09/getting-to-know-you-part-1/}{b} \B{ayngaru oeyä pxeylanti}, let me introduce to you my three friends.~\LINK{http://naviteri.org/2012/07/tskxekengtsyip-a-mikyunfpi-a-little-listening-exercise/}{b} 
(\ding{214}~\HL{kxutu}{\B{kxu\-tu}}, \HL{wAtu}{\B{wä\-tu}}) \\  
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'eylan}{\B{tì'eylan}}, friendship.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'eyng}{\B{tì\-'eyng}}, answer, respond.   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'i'a}{\B{tì'i'a}}, end.  
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'ipu}{\B{tì'ipu}}, humor. 
\on{2}.~\HL{sA'ipu}{\B{sä'ipu}}, s.t.~humorous.

% 'it
\hi
\HT{'it}{\B{'it}} \I{[Pit\textcorner]} \emph{n.} bit, small amount.\\  
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nI'it}{\B{nì'it}}, a bit. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{maitan}{\B{maitan}}, my son (address).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{maite}{\B{maite}}, my daughter (address).
...
\textsc{Derivations}: \ding{43} \on{1}. \HL{'awnIm}{\B{'awnìm}}, avoid.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{anIheyu}{\B{anìheyu}}, fibonacci.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIn}{\B{tìn}}, activity. 
\on{2}.~\HL{tIk'In}{\B{tìk'ìn}}, free time. 
\on{3}.~\HL{sulIn}{\B{sulìn}}, be busy (positive). 
\on{4}.~\HL{vrrIn}{\B{vrrìn}}, be busy (negative). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{le'InglIsI}{\B{le'Ìnglìsì}}, English, regarding English.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'ompin}{\B{'ompin}}, purple color.

% 'ompin
\hi
\HT{'ompin}{\B{\cp{'om}pin}} \I{["Pom.pin]} \emph{n.} the color \B{'om}. 
(\ding{43}~\HL{'om}{\B{'om}}, \HL{'opin}{\B{'o\-pin}})
...
\textsc{ii}. \B{'on si} \I{[Pon si]} \emph{vin.} shape; give shape (to s.t.) (\emph{physical shaping or metaphorically}).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{ko'on}{\B{ko'on}}, ring, oval. 
\on{2}.~\HL{'ongop}{\B{'ongop}}, design (\emph{for the larger aspects of design}).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'ong}{\B{tì'ong}}, unfolding, blooming. 
\on{2}.~\HL{'onglawn}{\B{'onglawn}}, \emph{exhiliration of first bonding}.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI'ongokx}{\B{tì'ongokx}}, birth.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'ongopyu}{\B{'ongopyu}}, designer.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{pxayopin}{\B{pxayopin}}, colorful. 
\on{2}.~\HL{'opinvultsyIp}{\B{'opinvultsyìp}}, crayon. 
\on{3}.~\HL{'opinsung}{\B{'opinsung}}, color, color in.

% 'opinsung
\hi
\HT{'opinsung}{\B{\cp{'o}pinsung}} \I{["Po.pin.s$\cdot$uN]} \emph{or} \I{[.s$\cdot$UN]} (\textsc{rn}: \B{\cp{'o}pinsùng} \I{["Po.pin.sUN]}) \emph{inf.}\on{33} (\emph{a. vtr.}) color, color in; paint, apply paints\slash dyes.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{}{\B{'oratsyìp}}, pond, pool.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{'uo}{\B{'uo}}, something. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tI.'ul}{\B{tì'ul}}, increase. 
