...
(\ding{43}~\HL{ya2}{\B{-ya}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{maitan}{\B{ma\-i\-tan}}, my son (address). 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kAmakto}{\B{kämakto}}, ride out.
\on{2}.~\HL{toruk makto}{\B{Toruk Makto}}, Rider of the Last Shadow.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImal}{\B{tìmal}}, trustworthiness.  
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mawkrr}{\B{maw\-krr}}, after, afterwards. 
...
\on{1}.~\HL{mawkrra}{\B{mawkrra\slash akrrmaw}}, after (\emph{conj.}).

% mawkrra
\hi
\HT{mawkrra}{\B{maw\cp{krr}a}} \I{[maw."k\s{r}.a]} \emph{or} \HL{akrrmaw}{\B{a\-\cp{\-krr}\-maw}} \I{[a."k\s{r}. maw]} \emph{conj.} after (\emph{temporal}).
...
% mawl
\hi
\HT{mawl}{\B{mawl}} \I{[mawl]} \emph{n.} (\emph{a. num.}) half, one\hyp{}half, $\frac{1}{2}$.
...
(\emph{b. to tell time}) \B{trr\-pxì a\-mrr\-ve sì mawl} \emph{or coll.} \B{mrr\-ve sì mawl}, (it's) \on{5}:\on{30}.~\LINK{https://naviteri.org/2024/05/krrteri-about-time/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{maweypey}{\B{ma\-wey\-pey}}, be patient. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImweypey}{\B{tìm\-wey\-pey}}, patience.   
...
% mawup
\hi
\B{\cp{ma}wup} \I{["ma.wup\textcorner]} \emph{or} \I{[.wUp\textcorner]} \emph{n., fauna} turtapede. \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mawuptsyìp}{\B{ma\-wup\-tsyìp}}, turtle.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{utumauti}{\B{u\-tu\-ma\-u\-ti}}, banana fruit. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tIme'em}{\B{tì\-me\-'em}}, (general) harmony.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{meitayo}{\B{mei\-ta\-yo}}, wetlands.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mektseng}{\B{mek\-tseng}}, gap, breach.  
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{meuianga'}{\B{me\-uia\-nga'}}, honorable. 
...
\B{Me\-fo fì\-tsap mä\-po\-le\-yam teng\-krr tsngaw\-vìk.} The two of them hugged each other and wept.~\LINK{http://naviteri.org/2011/10/more-vocabulary-a-bit-of-grammar/}{b} \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sAmyam}{\B{säm\-yam}}, hug, embrace.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImeyp}{\B{tì\-meyp}}, weakness. 
...
\textsc{ii}.~\HT{tIng mikyun}{\B{tìng \cp{mik}yun}} \I{[tIm."mik\textcorner.jun]} \emph{vin.} (\texttt{+}\emph{control}) listen, listen to. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{miktsang}{\B{mik\-tsang}}, earring. 
...
(\emph{idiom}) \B{Mip\-a zì\-sìt le\-fpom nga\-ru!} Happy New Year to you!~\LINK{http://naviteri.org/2011/01/new-year-new-vocabulary/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mIfa}{\B{mìfa}}, inside.   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nemfa}{\B{nem\-fa}}, into. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mInyu}{\B{mìn\-yu}}, turner; twisted lily.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImll'an}{\B{tì\-mll\-'an}}, acceptance.

% mllte
\hi
\HT{mllte}{\B{mll\cp{te}}} \I{[m\s{l}."tE]} (\textsc{perf.}~\B{mol\-te}) \emph{vin.} agree (\HL{hu}{\B{hu}}, with). 
...
(i.) \HT{moahahaw}{\B{mo a \cp{ha}haw}}, bedroom, sleeping area. \\
(ii.) \HT{moayom}{\B{mo a yom}}, dining room, dining area. \\
(iii.) \HT{moletrrtrr}{\B{mo le\cp{trr}trr}}, living room. \\  
(iv.) \HT{moafngA'}{\B{mo a fngä'}}, restroom (\emph{an enclosed private structure or room}). \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{snomo}{\B{sno\-mo}}, private space that one can retreat to.  
\on{2}.~\HL{momek}{\B{mo\-mek}}, hollow, not solid.
...
% moe
\hi
\HT{moe}{\B{\cp{mo}e}} \I{["mo.E]} \emph{pn.} we (two, not you), the two of us (excluding the listener) (1\textsuperscript{st} person dual exclusive).
...
% mohe
\hi
\HT{mohe}{\B{\cp{mo}he}} \I{["mo.hE]} \emph{pn.} we (two, not you), the two of us (excluding the listener) (1\textsuperscript{st} person dual exclusive; deferential\slash ceremonial form). 

% mok
\hi
\HT{mok}{\B{mok}} \I{[mok\textcorner]} \emph{vtr.} suggest.
\B{Nge\-yä tì\-pawm\-ìri mok oel fu\-ta ngal si\-var kem\-lì\-'u\-vit alu $\langle$irv$\rangle$.} As for your question, I suggest that you use the infix $\langle$irv$\rangle$.~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/comment-page-1/\#comment-1951}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImok}{\B{tì\-mok}}, suggestion, suggesting.   
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{utral aymokriyA}{\B{Ut\-ral Ay\-mok\-ri\-yä}}, Tree of Voices. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tsukmong}{\B{tsukmong}}, reliable, dependable.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mowarsiyu}{\B{mo\-war\-si\-yu}}, advisor.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{mrrtrr}{\B{mrr\-trr}}, (\on{5}\hyp{}day) week. 
\on{2}.~\HL{vospxImrr}{\B{Vo\-spxì\-mrr}}, May.

% mrr-
\hi
\HT{mrr1}{\B{mrr-}} \I{[m\s{r}.]} \emph{num.~pref.} five (\emph{base to form higher numbers or fractions}). \B{mrr\-vol}, \on{40} (decimal), \on{50} (octal); \B{mrr\-pxì}, one-fifth, $\frac{1}{5}$; \B{mrr\-pxì a\-tsìng}, four-fifth, $\frac{4}{5}$.

% mrrpxì
\hi
\HT{mrrpxI}{\B{mrr\cp{pxì}}} \I{[m\s{r}."p'I]} \emph{n.} one-fifth, $\frac{1}{5}$.
(\ding{43}~\HL{mrr1}{\B{mrr-}}, \HL{hapxI}{\B{ha\-pxì}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImu'ni}{\B{tì\-mu'\-ni}}, achievement, accomplishment.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImwiA}{\B{tìm\-wiä}}, fairness, justice.
...
% mun'i
\hi
\HT{mun'i}{\B{mun\cp{'i}}} \I{[mun."Pi]} \emph{or} \I{[mUn.]} \emph{vtr.} cut. \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{pxImun'i}{\B{pxì\-mun\-'i}}, divide, cut into parts. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nImun}{\B{nì\-mun}}, again. 
...
% munsna-
\hi
\HT{munsna1}{\B{munsna-}} \I{[mun.sna.]} \emph{or} \I{[mUn.]} \emph{pref.~to mean} pair, couple. 
...
(ii.) \B{muntrr\cp{ay}} \I{[mun.t\s{r}."{}aj]} \emph{n., adv.} next weekend. 
(\ding{43}~\HL{mune}{\B{mu\-ne}}, \HL{trr}{\B{trr}})

% muntxa / si / slu
\hi
\HT{muntxa}{\B{mun\cp{txa}}} \I{[mun."t'a]} \emph{or} \I{[mUn.]} \textsc{i}.~\emph{adj.} mated. \\
\textsc{ii}.a.~\B{mun\cp{txa} si} \I{[mun."t'a si]} \emph{or} \I{[mUn.]} \emph{vin.} mate (\ding{43}~\HL{hu}{\B{hu}}, with s.b.).
\B{Ìlä Fey\-ral, mun\-txa so\-li Ra\-lu sì Ne\-wey nì\-wan me\-srr\-am.} According to Peyral, Ralu and Newey were secretly married the day before yesterday.~\LINK{http://naviteri.org/2012/07/meetings-waterfalls-and-more/}{b}  
...
\textsc{ii}.b.~\B{mun\cp{txa} slu} \emph{vin.} get married.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{muntxatu}{\B{mun\-txa\-tu}}, spouse. \\  
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{muntxatan}{\B{mun\-txa\-tan}}, husband.   
\on{2}.~\HL{muntxate}{\B{mun\-txa\-te}}, wife.

% munge
\hi
\HT{munge}{\B{\cp{mu}nge}} \I{["mu.NE]} \emph{vtr.} take, bring. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{sAmunge}{\B{sä\-mu\-nge}}, transportation device. 
...
% mungsye
\hi 
\HT{mungsye}{\B{\cp{mung}sye}} \I{["m$\cdot$uN.sjE]} \emph{or} \I{["mUN.]} \emph{vin., inf.}\on{11} inhale. 
(\ding{43}~\HL{munge}{\B{mu\-nge}}, \HL{syeha}{\B{sye\-ha}}; \ding{214}~\HL{lonusye}{\B{lo\-nu\-sye}})

% mungwrr
\hi
\HT{mungwrr}{\B{mung\cp{wrr}}} \I{[muN."w\s{r}]} \emph{or} \I{[mUN.]} \emph{adp.} except.
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tImungwrr}{\B{tì\-mung\-wrr}}, exception. 
\on{2}.~\HL{mungwrrtxo}{\B{mung\-wrr\-txo}}, unless, except if.

% mungwrrtxo
\hi 
\HT{mungwrrtxo}{\B{mung\cp{wrr}txo}} \I{[muN."w\s{r}.t'o]} \emph{or} \I{[mUN.]} \emph{or coll.} \I{[muN."w\s{r}.to]} \emph{conj.} unless, except if. 
