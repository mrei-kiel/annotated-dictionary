...
% tsay+
\hi 
\HT{tsay}{\B{tsay}}\texttt{+} \I{[\t{ts}aj.]} \emph{prod. pref. on n.s} those (there) (\emph{distal singular dem. pref.}). 
...
% tsahìk
\hi
\HT{tsahIk}{\B{\cp{tsa}hìk}} \I{["\t{ts}a.hIk]} \emph{n.} Tsahik, high priestess (\emph{who interprets the will of Eywa}). 
...
% tsala
\hi
\HT{tsala}{\B{\cp{tsa}la}}, \B{tsa\-\cp{'u} a}, \emph{or} \B{a tsa\-\cp{'u}} \I{["\t{ts}a.la]} \emph{conj.} that (\emph{to introduce an agentive subordinate clause}). 
...
\textsc{Derivations}: \on{1}.~\HL{tsamsiyu}{\B{tsam\-si\-yu}}, warrior. 
...
% tsame-
\hi 
\HT{tsame}{\B{tsame}\texttt{+}} \I{[\t{ts}a.mE.]} \emph{prod. pref. on n.s} those two (there) (\emph{distal singular dem. pref.}). 
...
% tsamkuk
\hi
\HT{tsamkuk}{\B{\cp{tsam}kuk}} \I{["\t{ts}am.kuk]} \emph{or} \I{[.kUk]} \emph{n.} war drum. 
...
\B{Saw\-tu\-te\-ri tì\-fkey\-tok ke tsan\-'o\-lul kaw\-'it.} The situation with the Skypeople hasn't improved one bit.
\B{Lì'\-fya\-ri le\-Na'\-vi nga tsan\-'e\-re\-i\-ul fra\-trr.} I'm delighted that your Na'vi is improving every day.
\B{Ru\-txe fì\-tì\-oeyk\-tìng\-it tsan\-'ey\-ki\-vul. Ke lu law kaw\-'it.} Please improve this explanation. It's not at all clear.~\emph{all}~\LINK{http://naviteri.org/2013/03/tsanerul-feerul-getting-better-getting-worse/}{b}
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tItsan'ul}{\B{tìtsan'ul}}, improvement (abstract).
\on{2}.~\HL{sAtsan'ul}{\B{sätsan'ul}}, improvement (specific).
...
\on{1}.~\HL{tsankumnga'}{\B{tsankumnga'}}, adventageous.
...
(\ding{214}~\HL{kawngtu}{\B{kawngtu}}; \ding{43}~\HL{sIltsan}{\B{sìltsan}}, \HL{tute1}{\B{tute}})
...
\on{1}.~\HL{miktsang}{\B{miktsang}}, earring. \\
\on{2}.~\HL{ontsang}{\B{ontsang}}, nose ring.
...
(\emph{b. interj.}) ``(my) apologies''. \B{Tsap\-'a\-lu\-te, mì upxa\-re a fpo\-le' oel ay\-nga\-ru trr\-am lu kxey\-ey.} My apologies, in the message I sent you yesterday is a mistake.~\LINK{http://forum.learnnavi.org/language-updates/another-email-from-frommer/msg68133/\#msg68133}{b} \\
...
% tsapxe-
\hi 
\HT{tsapxe}{\B{tsapxe}\texttt{+}} \I{[\t{ts}a.p'E.]} \emph{prod. pref. on n.s} those three (there) (\emph{distal singular dem. pref.}). 
...
\on{1}.~\HL{kAsatseng}{\B{käsatseng}}, out there.
...
% tsawa
\hi
\HT{tsawa}{\B{\cp{tsa}wa}}, \B{tsa\-\cp{'u} a}, \emph{or} \B{a tsa\-\cp{{'u}}} \I{["\t{ts}a.wa]} \emph{conj.} that (\emph{to introduce a subordinate clause}). 
...
\B{Fä\-za'u tsaw\-ke krr\-pe?} When will the sun come up? 
\B{Tsaw\-ke fpxe\-rä\-kìm (nem\-fa taw).} The sun is rising.~\emph{both}~\LINK{http://naviteri.org/2012/01/more-additions-to-the-lexicon/}{b} \\
...
(\ding{43}~\HL{tsawke}{\B{tsawke}}, \HL{syulang}{\B{syulang}})
...
\textsc{Derivations:} \on{1}.~\HL{tsawlhI'}{\B{tsawl\-hì'}}, size. 
...
% tsawlapx
\hi
\HT{tsawlapx}{\B{\cp{tsawl}apx}} \I{["\t{ts}awl.ap']} : \HL{tsawlapxangrr}{\B{tsawlapxangrr}}
...
(\ding{43}~\HL{tsawl}{\B{tsawl}}, \HL{apxa}{\B{apxa}}, \HL{ngrr}{\B{ngrr}})
...
% tsawlultxa #
\hi
\HT{tsawlultxa}{\B{tsawlul\cp{txa}}} \I{[\t{ts}awl.ul."t'a]} \emph{or} \I{[.Ul.]} \emph{n.} large gathering, conference.   
...
\on{1}.~\HL{txumtsA'wll}{\B{txumtsä'wll}}, baja tickler.

% tsäfpìlyewn
\hi 
\B{tsä\cp{fpìl}yewn} \I{[\t{ts}\ae."fpIl.jEwn]}~:~\HL{tIsAfpIlyewn}{\B{tìsäfpìlyewn}})
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tseftanga'}{\B{tse\-fta\-nga'}}, vengeful. 
...
% tseltsul
\hi
\HT{tseltsul}{\B{\cp{tsel}tsul}} \I{["\t{ts}El.\t{ts}ul]} \emph{or} \I{[.\t{ts}Ul]} \emph{n.} whitewater rapids (\emph{countable, but only rarely}). 
...
\B{Lu Tse\-nur yawn\-yew\-la a lam fwa Va'\-rul pot txì\-yìng.} Tse\-nu is broken hearted that Va'\-ru appears to be about to dump her.
\B{Tse\-nur Lo\-ak ke hä\-nga'.} Loak isn't good for Tsenu.~\emph{both}~\LINK{http://naviteri.org/2012/10/mipa-vospxi-mipa-ayliu-new-words-for-the-new-month/}{b}
...
\textsc{Derivations}: \on{1}.~\HL{fItseng}{\B{fì\-tseng(e)}}, here. 
...
\B{Pey\-ral\-ä mik\-tsang\-it a\-mip ngal tso\-le\-ri srak?} Did you notice Pey\-ral's new earring?
\B{Oe\-ru txoa li\-vu. Ke tso\-le\-rä\-ngi oel fu\-ta nga\-ri kxe\-tse eo oe lu.} Forgive me. I didn't notice that your tail was in front of me.~\emph{both}~\LINK{http://naviteri.org/2015/03/kap-si-ayunil-saylahe-threats-dreams-and-other-things/}{b}
...
\textsc{Derivations}: \on{1}.~\HL{letsim}{\B{letsim}}, original, unique. 
...
\B{Tsìl\-pey\-lu\-ke ke tsun kaw\-tu ri\-vey.} No one can live without hope.
\B{Tsìl\-pey\-ìl tok txe'\-lan\-it.} Hope lives within the heart.~\emph{both}~\LINK{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}{b}
...
\on{1}.~\HL{vospxItsIng}{\B{Vospxìtsìng}}, April.
...
\on{1}.~\HL{sAtsIsyI}{\B{sätsìsyì}}, whisper. \\
\on{2}.~\HL{nItsyIsyI}{\B{nìtsìsyì}}, by whispering.
...
(\ding{43}~\HL{tskxepay}{\B{tskxe\-pay}})
...
(\ding{43}~\HL{tskxe}{\B{tskxe}}, \HL{mauti}{\B{mauti}}) 
...
\on{1}.~\HL{tskxaytsyIp}{\B{tskxaytsyìp}}, hail.
...
(\emph{a. conv.}) \B{tslo\cp{lam}} ``understood''. \B{Oe\-ri lu swoa fne\-txum.--Tslo\-lam.} I am allergic to alcohol.--Understood.~\LINK{http://naviteri.org/2012/10/audio-and-video-learning-materials-for-navi-101/}{b} \\
\textsc{Derivation}: \on{1}.~\HL{tItslam}{\B{tìtslam}}, understanding, intelligence. \\
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tslikxyulatopin}{\B{tslikx\-yu la\-to\-pin}}, chamelion crawler.   
...
(\ding{43}~\HL{tslikx}{\B{tslikx}}, \HL{latem}{\B{latem}}, \HL{'opin}{\B{'opin}})
...
\on{1}.~\HL{tsmisnrr}{\B{tsmisnrr}}, nectar lantern, bladder lantern.
...
\B{Fol tsngan\-it pxì\-mo\-lun\-'i nì\-'eng.} They shared the meat.
\B{Fol tsngan\-it pxì\-mo\-lun\-'i nì\-yll.} They shared the meat with the entire clan.~\emph{both}~\LINK{http://naviteri.org/2012/01/more-additions-to-the-lexicon/}{b}
...
\on{1}.~\HL{tsawsngem}{\B{tsawsngem}}, muscular.
...
\B{Oel tsre\-'i tskxet ne nga.} I throw a stone towards you.
\B{Oel tsre\-'i tskxet nga\-ru.} I throw a stone to you.
\B{Oel tsre\-'i tskxet wä nga.} I throw a stone at you.~\emph{all}~\LINK{http://forum.learnnavi.org/language-updates/to-throw-at-x/}{ln}
...
\B{Tung oer fu\-ta vin tstun\-kem\-it nga\-ta.} Let me ask you a favor.
...
\B{Tstun\-kem si oer ru\-txe.} Please do me a favor. \emph{both}~\LINK{http://naviteri.org/2020/03/mipa-sawasultsyip-a-new-contest/}{b} \\
\on{1}.~\HL{tstunkemtsyIp}{\B{tstunkemtsyìp}}, little favor.
...
% tstunwi
\hi
\HT{tstunwi}{\B{\cp{tstun}wi}} \I{["\t{ts}tun.wi]} \emph{or} \I{["\t{ts}tUn.]} \emph{adj.} kind, thoughtful, considerate.  
...
\on{1}.~\HL{tItstunwi}{\B{tìtstunwi}}, kindness. \\
\on{2}.~\HL{tstunkem}{\B{tstunkem}}, favor, act of kindness.
...
% tsuk-
\hi
\HT{tsuk}{\B{tsuk-}} \I{[\t{ts}uk\textcorner.]} \emph{or} \I{[\t{ts}Uk\textcorner.]} \emph{prod. pref. on verbs to form receptive ability, i.e., s.t. is capable of receiving the action of the verb}, ``…-able'' .
\B{Fì\-i\-o\-ang lu tsuk\-yom.} This animal is edible\slash can be eaten.
\B{Tsuk\-yom\-a ioang lu le\-sar.} An edible animal is useful.
(\emph{a. more prod. than in English}) \B{Lu na'\-rìng tsuk\-ha\-haw.} One can sleep in the forest.\slash It's possible to sleep in the forest.\slash The forest is ``sleepable''.
\B{Fì\-tseng lu tsuk\-tsu\-rokx.} One can rest here.\slash It's possible to rest here.\slash This place is ``restable''.~\emph{all}~\LINK{http://naviteri.org/2011/03/\%E2\%80\%9Creceptive-ability\%E2\%80\%9D-and-hesitation/}{b}
(\ding{214}~\HL{ketsuk-}{\B{ke\-tsuk-}}) 

% tsukanom
\hi 
\HT{tsukanom}{\B{tsu\cp{ka}nom}} \I{[\t{ts}u."ka.nom]} \emph{adj.} available, obtainable. 
...
\textsc{Derivations}: \on{1}.~\HL{tItsukanom}{\B{tì\-tsu\-ka\-nom}}, availability.

% tsukmong
\hi 
\HT{tsukmong}{\B{tsuk\cp{mong}}} \I{[\t{ts}uk\textcorner."moN]} \emph{or} \I{[\t{ts}Uk\textcorner.]} \emph{adj.} reliable, dependable. 
...
% tsukx
\hi 
\HT{tsukx}{\B{tsukx}} \I{[\t{ts}uk']} \emph{or} \I{[\t{ts}Uk']} \emph{vtr.} stab. 
...
% tsulfä 
\hi
\HT{tsulfA}{\B{tsul\cp{fä}}} \I{[\t{ts}ul."f\ae]} \emph{or} \I{[\t{ts}Ul.]} \textsc{i}. \emph{n.} mastery.
...
\textsc{ii}. \B{tsul\cp{fä} si} \I{[\t{ts}ul."f\ae{} si]} \emph{vin.} master. \\
\on{1}.~\HL{tsulfAtu}{\B{tsulfätu}}, master of an art.

% tsulfätu
\hi
\HT{tsulfAtu}{\B{tsul\cp{fä}tu}} \I{[\t{ts}ul."f\ae.tu]} \emph{or} \I{[\t{ts}Ul.]} \emph{n.} master of an art, craft, or skill; expert.
...
\on{1}.~\HL{tsulfAtunay}{\B{tsulfätunay}}, near\hyp{}master.

% tsulfätunay
\hi
\HT{tsulfAtunay}{\B{tsulfätu\cp{nay}}} \I{[\t{ts}ul.f\ae.tu."naj]} \emph{or} \I{[\t{ts}Ul.]} \emph{n.} near\hyp{}master, \emph{s.o. who is one step away from becoming a master}.
...
% tsun 2
\hi 
\HT{tsun2}{\B{tsun}}\textsuperscript{\on{2}} \I{[\t{ts}un]} \emph{or} \I{[\t{ts}Un]} (\textsc{rn}: \B{tsun} \I{[\t{ts}un]})  \emph{n.} heel. 
...
% tsunslu
\hi
\HT{tsunslu}{\B{\cp{tsun}slu}} \I{["\t{ts}un.slu]} \emph{or} \I{["\t{ts}Un.]}  \emph{vin.} may, be possible.
...
% tsupx
\hi 
\HT{tsupx}{\B{tsupx}} \I{[\t{ts}up']} \emph{or} \I{[\t{ts}Up']} \emph{vtr.} scratch harmfully (\emph{as with a claw}). 
\B{Pa\-lu\-kan\-ìl oe\-yä po\-ti fa tsin tso\-lä\-ngupx.} Unfortunately my cat scratched her with its claw.~\LINK{http://naviteri.org/2020/07/vospxivol-lefpom-happy-august/}{b} 
...
% tswayon  
\hi
\HT{tswayon}{\B{\cp{tsway}on}} \I{["\t{ts}waj.on]} (\emph{a. vin.}) fly (\B{fa}, with\slash by means of). 
...
\textsc{Derivations}: \ding{43}~\on{1}.~\HL{reyptswIk}{\B{reyp\-tswìk}}, wolf tick.
...
\B{Po\-ri wem\-tswo fra\-tsam\-si\-yur ro\-lo\-'a nì\-txan.} His ability to fight greatly impressed all the warriors.
\B{Kxa\-ri tstu\-tswo tsran\-ten krra ke lu kea sä\-fpìl le\-sar.} When one has no useful thoughts, the ability to close one's mouth is important.~\emph{both}~\LINK{http://naviteri.org/2012/03/spring-vocabulary-part-2/}{b}
...
\textsc{Derviations}: \ding{43} \on{1}.~\HL{lortsyal}{\B{lor\-tsyal}}, shimmyfly.
...
\on{1}.~\HL{tItsyAr}{\B{tìtsyär}}, rejection.
...
\on{1}.~\HL{tsyeytsyIp}{\B{tsyeytsyìp}}, tiny bite. \\
\on{1}.~\HL{niktsyey}{\B{niktsyey}}, food wrap.
...
% tsyìmawnun'i
\hi 
\HT{tsyImawnun'i}{\B{tsyìmawnun\cp{'i}}} \I{[\t{ts}jI.maw.nun."Pi]} \emph{or} \I{[.nUn.]} \emph{n., shortened form of} \ding{43}~\HL{tIsyImawnun'i}{\B{tì\-syì\-maw\-nun\-'i}}, independence,  freedom from a pre\hyp{}existing relationship. 
...
% -tsyìp
\hi
\HT{-tsyIp}{\B{-tsyìp}} \I{[.\t{ts}jIp\textcorner]} \emph{prod. suf. to nouns and pronouns to form the diminutive form}.
(\emph{a. to form new lexical items that originated as small versions of a noun}) e.g. \ding{43} \B{puk\-tsyìp}, booklet, pamphlet; 
\B{ut\-ral\-tsyìp}, bush; 
\B{sä\-spxin\-tsyìp}, minor ailment.
(\emph{b. to express affection or endearment})
\B{Za\-'u fì\-tseng, ma 'ite\-tsyìp.} Come here, little daughter.
\B{Kam\-tsyìp\-ìl wu\-tsot ye\-rom.} Little Kamun is having dinner.
\B{Nga\-tsyìp yaw\-ne lu oer.} I love you, little one.
\B{Nga\-ri tswin\-tsyìp se\-vin nì\-txan lu nang!} What a pretty little queue you have!
(\emph{c. to express disparagement or insult})
\B{Nga nì\-aw\-no\-mum to oe\-tsyìp lu txur nì\-txan.} As everyone knows, you're a lot stronger than little old me.
\B{Nga\-tsyìp\-ìl new pe\-ut ta oe?} What does little you want from me?
\B{Fì\-ta\-ron\-yu\-tsyìp ke tsun ke\-'ut sti\-vä'\-nì.} This little hunter can't catch anything.~\emph{all}~\LINK{http://naviteri.org/2010/07/diminutives-conversational-expressions/}{b}
...
\on{1}.~\HL{tItsyul}{\B{tìtsyul}}, beginning, start.
