...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{manga}{\B{ma\-nga}}, ``hey you''. 
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{nga'prrnen}{\B{nga'prrnen}}, be pregnant (for people).
...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tInga'lini}{\B{tì\-nga'\-li\-ni}}, pregnancy (\emph{for animals}).
...
(\emph{b.}) be pragnant \emph{with}, use \ding{43}~\HL{nga'}{\B{nga'}}, e.g. \B{Pol pxey\-a prr\-nen\-it nge\-i\-a'.} I'm delighted to say she's pregnant with triplets.~\LINK{http://naviteri.org/2024/02/mipa-ayliu-si-aylifyavi-niul-more-new-words-and-expressions/}{b}
(\ding{43}~\HL{nga'}{\B{nga'}}, \HL{prrnen}{\B{prr\-nen}}) \\
\textsc{Derivations}: \ding{43} \on{1}.~\HL{tInga'prrnen}{\B{tì\-nga'\-prr\-nen}}, pregnancy (\emph{for people}).
...
\B{Me\-lì\-'u alu mung\-wrr sì nì\-fkrr ngam\-pam si.} The words \emph{mung\-wrr} and \emph{nì\-fkrr} rhyme.
(\emph{b. fig.}) get along, fit together well. 
\B{New Ri\-ni sì Ra\-lu mun\-txa sli\-vu, slä tì\-'e\-fu\-mì oe\-yä, ngam\-pam ke si.} Rini and Ralu want to marry, but I feel they're not compatible.~\emph{both}~\LINK{http://naviteri.org/2012/01/mipa-zisit-ayliu-amip-new-words-for-the-new-year/}{b}
...
% ngim
\hi
\HT{ngim}{\B{ngim}} \I{[Nim]} \emph{adj.} long (\emph{about space}).
...
% ngimpup
\hi
\HT{ngimpup}{\B{ngim\cp{pup}}} \I{[Nim."pup\textcorner]} \emph{or} \I{[."pUp\textcorner]} \textsc{i}. \emph{n.} length (of physical extension). \\
\textsc{ii}. \B{\cp{ngim}puppe} \I{["Nim.pup.pE]} \emph{or} \I{[."pUp\textcorner.]} \emph{or} \HL{pengimpup}{\B{pe\cp{ngim}pup}} \emph{or} \I{[."pUp\textcorner]} \emph{inter.} what length? how long (of physical extension)?
...
\B{Nge\-yä ik\-ran\-ìl ngip\-it le\-tam kin fte tsi\-vun kll\-pi\-vä.} Your ikran needs enough open space to be able to land.
...
\B{Ftu\-e lu fwa ta\-ron ngong\-a io\-ang\-it to fwa ta\-ron pum\-it a lu wa\-lak sì win.} It's easier to hunt lethargic animals than to hunt perky, speedy ones.
(\emph{b. of people with pejorative force}) lazy.
\B{Fì\-trr oe 'e\-fu ngong nì\-wotx.} I'm just not motivated to do anything today.~\emph{both}~\LINK{http://naviteri.org/2011/10/more-vocabulary-a-bit-of-grammar/}{b}
(\ding{214}~\B{walak}) \\  
...
% ngrr
\hi
\HT{ngrr}{\B{ngrr}} \I{[N\s{r}]} \emph{n.} root. \\
...
% ngulpin
\hi
\HT{ngulpin}{\B{\cp{ngul}pin}} \I{["Nul.pin]} \emph{or} \I{["NUl.]} \emph{n.} the color grey.
(\ding{43}~\HL{ngul}{\B{ngul}}, \HL{'opin}{\B{'opin}})

% ngungung
\hi 
\HT{ngungung}{\B{\cp{ngu}ngung}} \I{["Nu.NuN]} \emph{or} \I{[.NUN]} \emph{vtr.} rub. 
