...
\textsc{Derivations}: \ding{43} \on{1}.~\HL{kxamlA}{\B{kxam\-lä}}, through, via the middle of.
...
% ‹ìly›
\hi
‹\B{ìly}› \I{[Il.j]} \emph{inf.~in} ‹1› \emph{to indicate perfective approximate future}.
...
% ‹ìsy›
\hi
‹\B{ìsy}› \I{[I.sj]} \emph{inf.~in} ‹1› \emph{to indicate determinational approximate future}.
...
% ‹ìy›
\hi
‹\B{ìy}› \I{[I.j]} \emph{inf.~in} ‹1› \emph{to indicate approximate future}. 
