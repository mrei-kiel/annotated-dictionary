...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{eyktan}{\B{eyktan}}, leader. 
...
(\emph{b. alternatively with} \HL{fa}{\B{fa}} \emph{to inroduce the caused person}) \B{Ey\-tu\-kan\-ìl fa Ney\-ti\-ri ye\-ri\-kit tey\-ko\-la\-ron.} Eytukan had a hexapede hunted by Neytiri.~\LINK{http://wiki.learnnavi.org/index.php?title=Canon\#Extracts_from_various_emails}{wiki}
(\emph{c. to make a \emph{vin.} into a \emph{vtr.}}) \B{A\-pxa tì\-väng\-ìl po\-ti stey\-ko\-li.} (His) great thirst made him angry.~\LINK{http://naviteri.org/2011/01/new-year-new-vocabulary/}{b} 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIeyktan}{\B{tìeyktan}}, leadership. 
...
\textsc{Derivations:} \ding{43} \on{1}. \HL{eywa'eveng}{\B{Eywa'eveng}}, (the moon) Pandora.
