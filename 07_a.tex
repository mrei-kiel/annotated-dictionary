...
(\emph{to form conj.s}): \ding{43}~\B{\HL{alu}{\B{a\-lu}}, \HL{krra}{krr\-a}, \HL{takrra}{ta\-krr\-a}, \HL{mawkrra}{maw\-krr\-a}, \HL{srekrra}{sre\-krr\-a}, \HL{fwa}{fwa}, \HL{fula}{fu\-la}, \HL{futa}{fu\-ta}, \HL{furia}{fu\-ri\-a}, \HL{fayluta}{fay\-lut\-a}, \HL{fmawnta}{fmawn\-ta}, \HL{kuma}{kum\-a}, \HL{teynga}{teyng\-a}, \HL{teyngla}{teyng\-la}, \HL{teyngta}{teyng\-ta}, \HL{tsenga}{tse\-nga}, \HL{tsonta}{tson\-ta}} 

% -a-
\hi
\HT{a-}{\B{a-}} \emph{or} \B{-a} \I{[a]} \emph{pref., suf.} (\emph{a. used to attribute an adj. to a noun} (\emph{attributive adj.})) \B{tsa\-krr pa\-ye\-'un swey\-a fya\-'ot}, then (I) will decide on the best way.~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln} \B{Ay\-lì\-'u\-fa aw\-nge\-yä 'ey\-lan\-ä a\-'e\-wan}, in the words of our young friend.~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln} (\emph{b. used to attribute active and passive participles to a noun}) \B{Pa\-lu\-lu\-kan a\-tu\-sa\-ron lu le\-hrr\-ap.} A hunting thanator is dangerous.~\LINK{http://forum.learnnavi.org/language-updates/participles/}{ln} \B{lì'\-fya a\-paw\-nll\-txe}, a spoken language.~\LINK{http://forum.learnnavi.org/language-updates/a-new-participle-infix-awn/msg140685/\#msg140685}{ln} 
...
% a krr
\hi
\HT{a krr}{\B{a \cp{krr}}} \emph{or} \HL{krra}{\B{krr a}}, \HL{krra}{\B{\cp{krr}a}} \I{[a "k\s{r}]} \emph{or} \I{["k\s{r}.a]} \emph{conj.} when (\emph{to conclude a clause of time}). \B{tì\-'eyng\-it oel to\-lel a krr, ay\-nga\-ru pa\-yeng}, when I have recieved an answer, (I) will tell you.~\LINK{http://forum.learnnavi.org/news-announcements/a-response-from-paul-frommer!/}{ln} 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{nafpawng}{\B{nafpawng}}, grievingly, with grief.

% Aha'ri
\hi
\B{Aha'ri} \I{[a.haP.Ri]} \emph{n.} \emph{female name}.
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{tIaho}{\B{tìaho}}, prayer (abstract). 
\on{2}.~\HL{saho}{\B{saho}}, prayer.
...
% alìm
\hi
\HT{alIm}{\B{a\cp{lìm}}} \I{[a."lIm]} \emph{adv.} far away, at a distance. \B{'Ì'awn alìm!} Stay back!~\LINK{http://forum.learnnavi.org/language-updates/near-distant-and-irregular-adverbs/}{a\slash ln} 
(\ding{43}~\HL{lIm}{\B{lìm}}) \\
\textsc{Derivations:} \ding{43} \on{1}. \HL{'awnIm}{\B{'awnìm}}, avoid.

% ‹alm›
\hi
‹\B{alm}› \I{[al.m]} \emph{inf. in} ‹1› \emph{to form the perfective past}. \B{na'\-rìng a ke lal\-mu tsar kea rìk}, the forest that had no leaves.~\LINK{http://forum.learnnavi.org/language-updates/for-\%28duration\%29-jesus-loan-word/}{ln} \B{Fkxi\-let a tsaw\-fa poe ioi sä\-pal\-mi ngo\-lop Va'\-rul.} Va'ru is the one who created the necklace she was wearing.~\LINK{http://naviteri.org/2011/08/new-vocabulary-clothing/}{b} \B{Lì'\-fya\-ri le\-Na'\-vi 'Rr\-ta\-mì, vay set 'al\-mong a fra\-'u ze\-ra\-'u ta ngrr\-po\-ngu.} Everything that has gone on with (blossomed regarding) Na'vi until now on Earth has come from a grassroots movement.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Good_Morning_America}{wiki}

% alo
\hi
\HT{alo}{\B{\cp{a}lo}} \I{["{}a.lo]} \emph{n.} time, turn, instance. 
...
% alunta
\hi
\B{a\cp{lun}ta}~:~\HL{taluna}{\B{taluna}}

% ‹aly›
\hi
‹\B{aly}› \I{[al.j]} \emph{inf. in} ‹1› \emph{to form the perfective future}.

% ‹am›
\hi
‹\B{am}› \I{[a.m]} \emph{inf. in} ‹1› \emph{to form the past tense}. \B{Ay\-lì'\-fya yaw\-ne le\-ru oer ta\-krr\-a 'e\-veng la\-mu.} I've loved languages since I was a child.~\LINK{http://naviteri.org/2011/01/new-year-new-vocabulary/}{b}

% am'a
\hi
\HT{am'a}{\B{am\cp{'a}}} \I{[am."Pa]} \emph{n.} doubt. \B{Ke lu oer am'a.} I have no doubt.~\LINK{http://naviteri.org/2011/05/weather-part-2-and-a-bit-more-2/}{b} \\
\textsc{Derivations:} \ding{43} \on{1}. \HL{am'ake}{\B{am'ake}}, sure, confident. 
\on{2}.~\HL{am'aluke}{\B{am'aluke}}, without a doubt.

% am'ake
\hi
\HT{am'ake}{\B{am\cp{'a}ke}} \I{[am."Pa.kE]} \emph{adj.} sure, confident. \B{Tsa\-ri\-a pol aw\-nga\-ti ke txa\-yìng oe 'e\-fu am\-'a\-ke nì\-wotx.} I'm entirely confident that he won't abandon us.~\LINK{http://naviteri.org/2012/06/spring-vocabulary-part-3/}{b}
(\ding{43}~\HL{am'a}{\B{am\-'a}})

% am'aluke
\hi
\HT{am'aluke}{\B{am\cp{'a}luke}} \I{[am."Pa.lu.kE]} \emph{adv.} without a doubt. \B{Am\-'a\-lu\-ke sna\-yaytx Saw\-tu\-te, ya\-yo\-ra' Na'\-vi.} Without a doubt the Sky People will lose and the People will win.~\LINK{http://naviteri.org/2012/06/spring-vocabulary-part-3/}{b}
...
\textsc{Derivations:} \ding{43} \on{1}. \HL{apxangrr}{\B{apxangrr}}, delta tree.
...
% ‹arm›
\hi
‹\B{arm}› \I{[aR.m]} \emph{inf. in} ‹1› \emph{to form the imperfective past}. 
...
% ‹ary›
\hi
‹\B{ary}› \I{[aR.j]} \emph{inf.~in} ‹1› \emph{to form the imperfective future}.
...
% ‹asy›
\hi
‹\B{asy}› \I{[a.sj]} \emph{inf. in} ‹1› \emph{to form the intentional future}. 
...
\B{Fra\-tseng lu atan, fnu fra\-po.} Everywhere is light, everyone is guiet.~\LINK{http://forum.learnnavi.org/news-announcements/christmas-song-ninavi-on-youtube/}{ln} \\  
...
% atxkxe
\hi
\HT{atxkxe}{\B{atx\cp{kxe}}} \I{[at'."k'E]} \emph{n} land. \B{Tsun aw\-nga kel\-ku si\-vi nì\-'eng Saw\-tu\-te\-hu mì atx\-kxe aw\-nge\-yä.} We can share our land with the Skypeople.~\LINK{http://naviteri.org/2012/01/more-additions-to-the-lexicon/}{b} 
...
\textsc{Derivations:} \ding{43} \on{1}.~\HL{atxkxerel}{\B{atxkxerel}}, map. 
\on{2}.~\HL{txanlokxe}{\B{txanlokxe}}, tribal or clan domain; country.

% atxkxerel
\hi
\B{atx\cp{kxe}rel} \I{[at'."k'E.REl]} \emph{n.} map.
(\ding{43}~\HL{atxkxe}{\B{atx\-kxe}}, \HL{rel}{\B{rel}})

% ‹ats›
\hi
‹\B{ats}› \I{[a.\t{ts}]} \emph{inf. in} ‹2› \emph{to form the evidential, i.e. uncertainty or indirect knowledge}. 
